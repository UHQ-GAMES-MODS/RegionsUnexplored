...
public class RuBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        add(RuBlocks.POTTED_ASHEN_SAPLING.get(), createPotFlowerItemTable(RuBlocks.ASHEN_SAPLING.get()));
        add(RuBlocks.POTTED_ALPHA_SAPLING.get(), createPotFlowerItemTable(RuBlocks.ALPHA_SAPLING.get()));
        add(RuBlocks.POTTED_APPLE_OAK_SAPLING.get(), createPotFlowerItemTable(RuBlocks.APPLE_OAK_SAPLING.get()));
        add(RuBlocks.POTTED_BAMBOO_SAPLING.get(), createPotFlowerItemTable(RuBlocks.BAMBOO_SAPLING.get()));
        add(RuBlocks.POTTED_BAOBAB_SAPLING.get(), createPotFlowerItemTable(RuBlocks.BAOBAB_SAPLING.get()));
        add(RuBlocks.POTTED_BLACKWOOD_SAPLING.get(), createPotFlowerItemTable(RuBlocks.BLACKWOOD_SAPLING.get()));
        add(RuBlocks.POTTED_BRIMWOOD_SAPLING.get(), createPotFlowerItemTable(RuBlocks.BRIMWOOD_SAPLING.get()));
        add(RuBlocks.POTTED_COBALT_SAPLING.get(), createPotFlowerItemTable(RuBlocks.COBALT_SAPLING.get()));
        add(RuBlocks.POTTED_CACTUS_FLOWER.get(), createPotFlowerItemTable(RuBlocks.CACTUS_FLOWER.get()));
        add(RuBlocks.POTTED_MAGNOLIA_SAPLING.get(), createPotFlowerItemTable(RuBlocks.MAGNOLIA_SAPLING.get()));
        add(RuBlocks.POTTED_CYPRESS_SAPLING.get(), createPotFlowerItemTable(RuBlocks.CYPRESS_SAPLING.get()));
        add(RuBlocks.POTTED_DEAD_PINE_SAPLING.get(), createPotFlowerItemTable(RuBlocks.DEAD_PINE_SAPLING.get()));
        add(RuBlocks.POTTED_DEAD_SAPLING.get(), createPotFlowerItemTable(RuBlocks.DEAD_SAPLING.get()));
        add(RuBlocks.POTTED_EUCALYPTUS_SAPLING.get(), createPotFlowerItemTable(RuBlocks.EUCALYPTUS_SAPLING.get()));
        add(RuBlocks.POTTED_FLOWERING_SAPLING.get(), createPotFlowerItemTable(RuBlocks.FLOWERING_SAPLING.get()));
        add(RuBlocks.POTTED_GOLDEN_LARCH_SAPLING.get(), createPotFlowerItemTable(RuBlocks.GOLDEN_LARCH_SAPLING.get()));
        add(RuBlocks.POTTED_JOSHUA_SAPLING.get(), createPotFlowerItemTable(RuBlocks.JOSHUA_SAPLING.get()));
        add(RuBlocks.POTTED_KAPOK_SAPLING.get(), createPotFlowerItemTable(RuBlocks.KAPOK_SAPLING.get()));
        add(RuBlocks.POTTED_LARCH_SAPLING.get(), createPotFlowerItemTable(RuBlocks.LARCH_SAPLING.get()));
        add(RuBlocks.POTTED_MAPLE_SAPLING.get(), createPotFlowerItemTable(RuBlocks.MAPLE_SAPLING.get()));
        add(RuBlocks.POTTED_MAUVE_SAPLING.get(), createPotFlowerItemTable(RuBlocks.MAUVE_SAPLING.get()));
        add(RuBlocks.POTTED_ORANGE_MAPLE_SAPLING.get(), createPotFlowerItemTable(RuBlocks.ORANGE_MAPLE_SAPLING.get()));
        add(RuBlocks.POTTED_PALM_SAPLING.get(), createPotFlowerItemTable(RuBlocks.PALM_SAPLING.get()));
        add(RuBlocks.POTTED_PINE_SAPLING.get(), createPotFlowerItemTable(RuBlocks.PINE_SAPLING.get()));
        add(RuBlocks.POTTED_BLUE_MAGNOLIA_SAPLING.get(), createPotFlowerItemTable(RuBlocks.BLUE_MAGNOLIA_SAPLING.get()));
        add(RuBlocks.POTTED_PINK_MAGNOLIA_SAPLING.get(), createPotFlowerItemTable(RuBlocks.PINK_MAGNOLIA_SAPLING.get()));
        add(RuBlocks.POTTED_REDWOOD_SAPLING.get(), createPotFlowerItemTable(RuBlocks.REDWOOD_SAPLING.get()));
        add(RuBlocks.POTTED_RED_MAPLE_SAPLING.get(), createPotFlowerItemTable(RuBlocks.RED_MAPLE_SAPLING.get()));
        add(RuBlocks.POTTED_ENCHANTED_BIRCH_SAPLING.get(), createPotFlowerItemTable(RuBlocks.ENCHANTED_BIRCH_SAPLING.get()));
        add(RuBlocks.POTTED_SILVER_BIRCH_SAPLING.get(), createPotFlowerItemTable(RuBlocks.SILVER_BIRCH_SAPLING.get()));
        add(RuBlocks.POTTED_SMALL_OAK_SAPLING.get(), createPotFlowerItemTable(RuBlocks.SMALL_OAK_SAPLING.get()));
        add(RuBlocks.POTTED_SOCOTRA_SAPLING.get(), createPotFlowerItemTable(RuBlocks.SOCOTRA_SAPLING.get()));
        add(RuBlocks.POTTED_WHITE_MAGNOLIA_SAPLING.get(), createPotFlowerItemTable(RuBlocks.WHITE_MAGNOLIA_SAPLING.get()));
        add(RuBlocks.POTTED_WILLOW_SAPLING.get(), createPotFlowerItemTable(RuBlocks.WILLOW_SAPLING.get()));
        ...
        /*-----------------LEAVES-----------------*/
        add(RuBlocks.ALPHA_NATURAL_SET.getLeaves(), (block) -> createLeavesDrops(block, RuBlocks.ALPHA_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.APPLE_OAK_NATURAL_SET.getLeaves(), (block) -> createOakLeavesDrops(block, RuBlocks.APPLE_OAK_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.ASHEN_LEAVES.get(), (block) -> createOakLeavesDrops(block, RuBlocks.ASHEN_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.BAMBOO_NATURAL_SET.getLeaves(), (block) -> createLeavesDrops(block, RuBlocks.BAMBOO_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.BAOBAB_NATURAL_SET.getLeaves(), (block) -> createLeavesDrops(block, RuBlocks.BAOBAB_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.BLACKWOOD_NATURAL_SET.getLeaves(), (block) -> createLeavesDrops(block, RuBlocks.BLACKWOOD_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.COBALT_WEBBING.get(), (block) -> createLeavesDrops(block, RuBlocks.COBALT_SAPLING.get(), COBALT_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.MAGNOLIA_NATURAL_SET.getLeaves(), (block) -> createLeavesDrops(block, RuBlocks.MAGNOLIA_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.CYPRESS_NATURAL_SET.getLeaves(), (block) -> createLeavesDrops(block, RuBlocks.CYPRESS_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.DEAD_NATURAL_SET.getLeaves(), (block) -> createLeavesDrops(block, RuBlocks.DEAD_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.DEAD_PINE_NATURAL_SET.getLeaves(), (block) -> createLeavesDrops(block, RuBlocks.DEAD_PINE_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.EUCALYPTUS_NATURAL_SET.getLeaves(), (block) -> createLeavesDrops(block, RuBlocks.EUCALYPTUS_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.FLOWERING_NATURAL_SET.getLeaves(), (block) -> createOakLeavesDrops(block, RuBlocks.FLOWERING_SAPLING.get(), FLOWERING_OAK_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.GOLDEN_LARCH_NATURAL_SET.getLeaves(), (block) -> createLeavesDrops(block, RuBlocks.GOLDEN_LARCH_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.JOSHUA_NATURAL_SET.getLeaves(), (block) -> createDoublePlantWithSeedDropsNoGrass(block, RuBlocks.JOSHUA_NATURAL_SET.getLeaves(), RuBlocks.JOSHUA_SAPLING.get(), JOSHUA_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.KAPOK_NATURAL_SET.getLeaves(), (block) -> createLeavesDrops(block, RuBlocks.KAPOK_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.LARCH_NATURAL_SET.getLeaves(), (block) -> createLeavesDrops(block, RuBlocks.LARCH_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.MAPLE_NATURAL_SET.getLeaves(), (block) -> createOakLeavesDrops(block, RuBlocks.MAPLE_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.MAUVE_NATURAL_SET.getLeaves(), (block) -> createOakLeavesDrops(block, RuBlocks.MAUVE_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.ORANGE_MAPLE_NATURAL_SET.getLeaves(), (block) -> createOakLeavesDrops(block, RuBlocks.ORANGE_MAPLE_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.PALM_NATURAL_SET.getLeaves(), (block) -> createLeavesDrops(block, RuBlocks.PALM_SAPLING.get(), PALM_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.PINE_NATURAL_SET.getLeaves(), (block) -> createLeavesDrops(block, RuBlocks.PINE_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.BLUE_MAGNOLIA_NATURAL_SET.getLeaves(), (block) -> createLeavesDrops(block, RuBlocks.BLUE_MAGNOLIA_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.PINK_MAGNOLIA_NATURAL_SET.getLeaves(), (block) -> createLeavesDrops(block, RuBlocks.PINK_MAGNOLIA_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.REDWOOD_NATURAL_SET.getLeaves(), (block) -> createLeavesDrops(block, RuBlocks.REDWOOD_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.RED_MAPLE_NATURAL_SET.getLeaves(), (block) -> createOakLeavesDrops(block, RuBlocks.RED_MAPLE_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.BRIMWOOD_NATURAL_SET.getLeaves(), (block) -> createSilkTouchOrShearsDispatchTable(block, this.applyExplosionCondition(block, LootItem.lootTableItem(RuBlocks.BRIMWOOD_SAPLING.get())).when(BonusLevelTableCondition.bonusLevelFlatChance(registries.holderOrThrow(Enchantments.FORTUNE), NORMAL_LEAVES_SAPLING_CHANCES))).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).when(HAS_NO_SHEARS_OR_SILK_TOUCH)));
        add(RuBlocks.SILVER_BIRCH_NATURAL_SET.getLeaves(), (block) -> createLeavesDrops(block, RuBlocks.SILVER_BIRCH_SAPLING.get(), ASPEN_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.SMALL_OAK_NATURAL_SET.getLeaves(), (block) -> createOakLeavesDrops(block, RuBlocks.SMALL_OAK_SAPLING.get(), SMALL_OAK_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.SOCOTRA_NATURAL_SET.getLeaves(), (block) -> createLeavesDrops(block, RuBlocks.SOCOTRA_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.ENCHANTED_BIRCH_NATURAL_SET.getLeaves(), (block) -> createLeavesDrops(block, RuBlocks.ENCHANTED_BIRCH_SAPLING.get(), ASPEN_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.WHITE_MAGNOLIA_NATURAL_SET.getLeaves(), (block) -> createLeavesDrops(block, RuBlocks.WHITE_MAGNOLIA_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        add(RuBlocks.WILLOW_NATURAL_SET.getLeaves(), (block) -> createLeavesDrops(block, RuBlocks.WILLOW_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
