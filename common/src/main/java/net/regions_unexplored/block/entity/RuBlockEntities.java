...
public class RuBlockEntities {
    ...
    public static Supplier<BlockEntityType> SIGN_BLOCK_ENTITIES;
    public static Supplier<BlockEntityType> HANGING_SIGN_BLOCK_ENTITIES;

    public static void addBlockEntities() {
        SIGN_BLOCK_ENTITIES = registerBlockEntity("sign_block_entity",
        ...
        HANGING_SIGN_BLOCK_ENTITIES = registerBlockEntity("hanging_sign_block_entity",
