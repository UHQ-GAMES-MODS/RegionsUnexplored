...
public class RuBlocks {
    ...
    public static final Supplier<Block> STEPPE_SHRUB = BlockRegistry.registerDefaultBlock("steppe_shrub", () -> new RuPlantBlock(BlockBehaviour.Properties.ofFullCopy(STEPPE_GRASS)));
    ...
    public static final Supplier<Block> SALMON_POPPY_BUSH = BlockRegistry.registerDefaultBlock("salmon_poppy_bush", () -> new RuFlowerBlock(MobEffects.WEAKNESS, 3, BlockBehaviour.Properties.ofFullCopy(POPPY_BUSH)));
    ...
    public static final Supplier<Block> BLACKWOOD_SHRUB = BlockRegistry.registerDefaultBlock("blackwood_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> BRIMWOOD_SHRUB = BlockRegistry.registerDefaultBlock("brimwood_shrub", () -> new BrimwoodShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> MAGNOLIA_SHRUB = BlockRegistry.registerDefaultBlock("magnolia_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> CHERRY_SHRUB = BlockRegistry.registerDefaultBlock("cherry_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> CYPRESS_SHRUB = BlockRegistry.registerDefaultBlock("cypress_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> DARK_OAK_SHRUB = BlockRegistry.registerDefaultBlock("dark_oak_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> DEAD_PINE_SHRUB = BlockRegistry.registerDefaultBlock("dead_pine_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> DEAD_SHRUB = BlockRegistry.registerDefaultBlock("dead_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> EUCALYPTUS_SHRUB = BlockRegistry.registerDefaultBlock("eucalyptus_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> FLOWERING_SHRUB = BlockRegistry.registerDefaultBlock("flowering_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> GOLDEN_LARCH_SHRUB = BlockRegistry.registerDefaultBlock("golden_larch_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> JOSHUA_SHRUB = BlockRegistry.registerDefaultBlock("joshua_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> JUNGLE_SHRUB = BlockRegistry.registerDefaultBlock("jungle_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> KAPOK_SHRUB = BlockRegistry.registerDefaultBlock("kapok_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> LARCH_SHRUB = BlockRegistry.registerDefaultBlock("larch_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> MANGROVE_SHRUB = BlockRegistry.registerDefaultBlock("mangrove_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> MAPLE_SHRUB = BlockRegistry.registerDefaultBlock("maple_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> MAUVE_SHRUB = BlockRegistry.registerDefaultBlock("mauve_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> OAK_SHRUB = BlockRegistry.registerDefaultBlock("oak_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> ORANGE_MAPLE_SHRUB = BlockRegistry.registerDefaultBlock("orange_maple_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> PALM_SHRUB = BlockRegistry.registerDefaultBlock("palm_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> PINE_SHRUB = BlockRegistry.registerDefaultBlock("pine_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> BLUE_MAGNOLIA_SHRUB = BlockRegistry.registerDefaultBlock("blue_magnolia_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> PINK_MAGNOLIA_SHRUB = BlockRegistry.registerDefaultBlock("pink_magnolia_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> REDWOOD_SHRUB = BlockRegistry.registerDefaultBlock("redwood_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> RED_MAPLE_SHRUB = BlockRegistry.registerDefaultBlock("red_maple_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> ENCHANTED_BIRCH_SHRUB = BlockRegistry.registerDefaultBlock("enchanted_birch_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> SILVER_BIRCH_SHRUB = BlockRegistry.registerDefaultBlock("silver_birch_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> SOCOTRA_SHRUB = BlockRegistry.registerDefaultBlock("socotra_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> SPRUCE_SHRUB = BlockRegistry.registerDefaultBlock("spruce_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> WHITE_MAGNOLIA_SHRUB = BlockRegistry.registerDefaultBlock("white_magnolia_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    public static final Supplier<Block> WILLOW_SHRUB = BlockRegistry.registerDefaultBlock("willow_shrub", () -> new ShrubBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_SHRUB)));
    //MUSHROOMS
    ...
    public static final Supplier<Block> GREEN_BIOSHROOM = BlockRegistry.registerDefaultBlock("green_bioshroom", () -> new BioshroomBlock(RuTreeGrowers.GREEN_BIOSHROOM, MobEffects.POISON, 10, BlockBehaviour.Properties.ofFullCopy(BLUE_BIOSHROOM).mapColor(MapColor.COLOR_LIGHT_GREEN)));
    public static final Supplier<Block> PINK_BIOSHROOM = BlockRegistry.registerDefaultBlock("pink_bioshroom", () -> new BioshroomBlock(RuTreeGrowers.PINK_BIOSHROOM, MobEffects.POISON, 10, BlockBehaviour.Properties.ofFullCopy(BLUE_BIOSHROOM).mapColor(MapColor.COLOR_PINK)));
    public static final Supplier<Block> YELLOW_BIOSHROOM = BlockRegistry.registerDefaultBlock("yellow_bioshroom", () -> new BioshroomBlock(RuTreeGrowers.YELLOW_BIOSHROOM, MobEffects.POISON, 10, BlockBehaviour.Properties.ofFullCopy(BLUE_BIOSHROOM).mapColor(MapColor.COLOR_YELLOW)));
    ...
    public static final Supplier<Block> TALL_GREEN_BIOSHROOM = BlockRegistry.registerDefaultBlock("tall_green_bioshroom", () -> new DoubleBioshroomBlock(BlockBehaviour.Properties.ofFullCopy(TALL_BLUE_BIOSHROOM)));
    public static final Supplier<Block> TALL_PINK_BIOSHROOM = BlockRegistry.registerDefaultBlock("tall_pink_bioshroom", () -> new DoubleBioshroomBlock(BlockBehaviour.Properties.ofFullCopy(TALL_BLUE_BIOSHROOM)));
    public static final Supplier<Block> TALL_YELLOW_BIOSHROOM = BlockRegistry.registerDefaultBlock("tall_yellow_bioshroom", () -> new DoubleBioshroomBlock(BlockBehaviour.Properties.ofFullCopy(TALL_BLUE_BIOSHROOM)));
    //OTHER_PLANT_BLOCKS
    ...
    public static final Supplier<Block> SPANISH_MOSS_PLANT = BlockRegistry.registerDefaultBlockNoItem("spanish_moss_plant", () -> new SpanishMossPlantBlock(BlockBehaviour.Properties.ofFullCopy(SPANISH_MOSS)));
    ...
    public static final Supplier<Block> KAPOK_VINES_PLANT = BlockRegistry.registerDefaultBlockNoItem("kapok_vines_plant", () -> new KapokVinesPlantBlock(BlockBehaviour.Properties.ofFullCopy(KAPOK_VINES)));
    ...
    public static final Supplier<Block> GIANT_LILY_PAD = BlockRegistry.registerDefaultBlockNoItem("giant_lily_pad", () -> new GiantLilyBlock(BlockBehaviour.Properties.ofFullCopy(FLOWERING_LILY_PAD)));
    ...
    public static final Supplier<Block> GREEN_BIOSHROOM_BLOCK = BlockRegistry.registerDefaultBlock("green_bioshroom_block", () -> new Block(BlockBehaviour.Properties.ofFullCopy(BLUE_BIOSHROOM_BLOCK).mapColor(MapColor.COLOR_GREEN)));
    public static final Supplier<Block> PINK_BIOSHROOM_BLOCK = BlockRegistry.registerDefaultBlock("pink_bioshroom_block", () -> new Block(BlockBehaviour.Properties.ofFullCopy(BLUE_BIOSHROOM_BLOCK).mapColor(MapColor.COLOR_PINK)));
    public static final Supplier<Block> YELLOW_BIOSHROOM_BLOCK = BlockRegistry.registerDefaultBlock("yellow_bioshroom_block", () -> new Block(BlockBehaviour.Properties.ofFullCopy(BLUE_BIOSHROOM_BLOCK).mapColor(MapColor.COLOR_YELLOW)));
    ...
    public static final Supplier<Block> GLOWING_GREEN_BIOSHROOM_BLOCK = BlockRegistry.registerDefaultBlock("glowing_green_bioshroom_block", () -> new Block(BlockBehaviour.Properties.ofFullCopy(GLOWING_BLUE_BIOSHROOM_BLOCK).mapColor(MapColor.COLOR_GREEN)));
    public static final Supplier<Block> GLOWING_PINK_BIOSHROOM_BLOCK = BlockRegistry.registerDefaultBlock("glowing_pink_bioshroom_block", () -> new Block(BlockBehaviour.Properties.ofFullCopy(GLOWING_BLUE_BIOSHROOM_BLOCK).mapColor(MapColor.COLOR_PINK)));
    public static final Supplier<Block> GLOWING_YELLOW_BIOSHROOM_BLOCK = BlockRegistry.registerDefaultBlock("glowing_yellow_bioshroom_block", () -> new Block(BlockBehaviour.Properties.ofFullCopy(GLOWING_BLUE_BIOSHROOM_BLOCK).mapColor(MapColor.COLOR_YELLOW)));
    //BAMBOO
    ...
    public static final Supplier<Block> BAOBAB_BRANCH = BlockRegistry.registerDefaultBlock("baobab_branch", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BRANCH));
    public static final Supplier<Block> BIRCH_BRANCH = BlockRegistry.registerDefaultBlock("birch_branch", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BRANCH));
    public static final Supplier<Block> BLACKWOOD_BRANCH = BlockRegistry.registerDefaultBlock("blackwood_branch", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BRANCH));
    public static final Supplier<Block> MAGNOLIA_BRANCH = BlockRegistry.registerDefaultBlock("magnolia_branch", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BRANCH));
    public static final Supplier<Block> CYPRESS_BRANCH = BlockRegistry.registerDefaultBlock("cypress_branch", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BRANCH));
    public static final Supplier<Block> CHERRY_BRANCH = BlockRegistry.registerDefaultBlock("cherry_branch", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BRANCH));
    public static final Supplier<Block> DARK_OAK_BRANCH = BlockRegistry.registerDefaultBlock("dark_oak_branch", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BRANCH));
    public static final Supplier<Block> DEAD_BRANCH = BlockRegistry.registerDefaultBlock("dead_branch", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BRANCH));
    public static final Supplier<Block> EUCALYPTUS_BRANCH = BlockRegistry.registerDefaultBlock("eucalyptus_branch", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BRANCH));
    public static final Supplier<Block> JOSHUA_BEARD = BlockRegistry.registerDefaultBlock("joshua_beard", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BEARD));
    public static final Supplier<Block> JUNGLE_BRANCH = BlockRegistry.registerDefaultBlock("jungle_branch", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BRANCH));
    public static final Supplier<Block> KAPOK_BRANCH = BlockRegistry.registerDefaultBlock("kapok_branch", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BRANCH));
    public static final Supplier<Block> LARCH_BRANCH = BlockRegistry.registerDefaultBlock("larch_branch", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BRANCH));
    public static final Supplier<Block> MANGROVE_BRANCH = BlockRegistry.registerDefaultBlock("mangrove_branch", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BRANCH));
    public static final Supplier<Block> MAPLE_BRANCH = BlockRegistry.registerDefaultBlock("maple_branch", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BRANCH));
    public static final Supplier<Block> MAUVE_BRANCH = BlockRegistry.registerDefaultBlock("mauve_branch", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BRANCH));
    public static final Supplier<Block> OAK_BRANCH = BlockRegistry.registerDefaultBlock("oak_branch", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BRANCH));
    public static final Supplier<Block> PALM_BEARD = BlockRegistry.registerDefaultBlock("palm_beard", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BEARD));
    public static final Supplier<Block> PINE_BRANCH = BlockRegistry.registerDefaultBlock("pine_branch", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BRANCH));
    public static final Supplier<Block> REDWOOD_BRANCH = BlockRegistry.registerDefaultBlock("redwood_branch", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BRANCH));
    public static final Supplier<Block> SILVER_BIRCH_BRANCH = BlockRegistry.registerDefaultBlock("silver_birch_branch", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BRANCH));
    public static final Supplier<Block> SOCOTRA_BRANCH = BlockRegistry.registerDefaultBlock("socotra_branch", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BRANCH));
    public static final Supplier<Block> SPRUCE_BRANCH = BlockRegistry.registerDefaultBlock("spruce_branch", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BRANCH));
    public static final Supplier<Block> WILLOW_BRANCH = BlockRegistry.registerDefaultBlock("willow_branch", () -> new BranchBlock(BlockBehaviour.Properties.ofFullCopy(ACACIA_BRANCH), BranchBlock.BranchType.BRANCH));
    ...
    public static final Supplier<Block> CHALK_BRICK_STAIRS = BlockRegistry.registerDefaultBlock("chalk_brick_stairs", () -> new StairBlock(CHALK.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(CHALK_BRICKS)));
    ...
    public static final Supplier<Block> CHALK_STAIRS = BlockRegistry.registerDefaultBlock("chalk_stairs", () -> new StairBlock(CHALK.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(CHALK)));
    ...
    public static final Supplier<Block> POLISHED_CHALK_STAIRS = BlockRegistry.registerDefaultBlock("polished_chalk_stairs", () -> new StairBlock(CHALK.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(POLISHED_CHALK)));
    //STONES
    ...
    public static final Supplier<Block> BAOBAB_WALL_SIGN = BlockRegistry.registerDefaultBlockNoItem("baobab_wall_sign", () -> BlockRegistry.wallSign(SoundType.CHERRY_WOOD, BAOBAB_SIGN, RuWoodTypes.BAOBAB));
    ...
    public static final Supplier<Block> BAOBAB_WALL_HANGING_SIGN = BlockRegistry.registerDefaultBlockNoItem("baobab_wall_hanging_sign", () -> BlockRegistry.wallHangingSign(MapColor.WOOD, SoundType.CHERRY_WOOD, BAOBAB_HANGING_SIGN, RuWoodTypes.BAOBAB));
    //BLACKWOOD_BLOCKS
    ...
    public static final Supplier<Block> BLACKWOOD_WALL_SIGN = BlockRegistry.registerDefaultBlockNoItem("blackwood_wall_sign", () -> BlockRegistry.wallSign(SoundType.NETHER_WOOD, BLACKWOOD_SIGN, RuWoodTypes.BLACKWOOD));
    ...
    public static final Supplier<Block> BLACKWOOD_WALL_HANGING_SIGN = BlockRegistry.registerDefaultBlockNoItem("blackwood_wall_hanging_sign", () -> BlockRegistry.wallHangingSign(MapColor.TERRACOTTA_BLACK, SoundType.NETHER_WOOD, BLACKWOOD_HANGING_SIGN, RuWoodTypes.BLACKWOOD));
    ...
    public static final Supplier<Block> BLUE_BIOSHROOM_WALL_SIGN = BlockRegistry.registerDefaultBlockNoItem("blue_bioshroom_wall_sign", () -> BlockRegistry.wallSign(SoundType.CHERRY_WOOD, BLUE_BIOSHROOM_SIGN, RuWoodTypes.BLUE_BIOSHROOM));
    ...
    public static final Supplier<Block> BLUE_BIOSHROOM_WALL_HANGING_SIGN = BlockRegistry.registerDefaultBlockNoItem("blue_bioshroom_wall_hanging_sign", () -> BlockRegistry.wallHangingSign(MapColor.COLOR_LIGHT_BLUE, SoundType.CHERRY_WOOD, BLUE_BIOSHROOM_HANGING_SIGN, RuWoodTypes.BLUE_BIOSHROOM));
    //BRIMWOOD_BLOCKS
    ...
    public static final Supplier<Block> BRIMWOOD_WALL_SIGN = BlockRegistry.registerDefaultBlockNoItem("brimwood_wall_sign", () -> BlockRegistry.fireproofWallSign(SoundType.NETHER_WOOD, BRIMWOOD_SIGN, RuWoodTypes.BRIMWOOD));
    ...
    public static final Supplier<Block> BRIMWOOD_WALL_HANGING_SIGN = BlockRegistry.registerDefaultBlockNoItem("brimwood_wall_hanging_sign", () -> BlockRegistry.fireproofWallHangingSign(MapColor.COLOR_BROWN, SoundType.NETHER_WOOD, BRIMWOOD_HANGING_SIGN, RuWoodTypes.BRIMWOOD));
    //COBALT_BLOCKS
    ...
    public static final Supplier<Block> COBALT_WALL_SIGN = BlockRegistry.registerDefaultBlockNoItem("cobalt_wall_sign", () -> BlockRegistry.fireproofWallSign(SoundType.NETHER_WOOD, COBALT_SIGN, RuWoodTypes.COBALT));
    ...
    public static final Supplier<Block> COBALT_WALL_HANGING_SIGN = BlockRegistry.registerDefaultBlockNoItem("cobalt_wall_hanging_sign", () -> BlockRegistry.fireproofWallHangingSign(MapColor.COLOR_BLUE, SoundType.NETHER_WOOD, COBALT_HANGING_SIGN, RuWoodTypes.COBALT));
    //CYPRESS_BLOCKS
    ...
    public static final Supplier<Block> CYPRESS_WALL_SIGN = BlockRegistry.registerDefaultBlockNoItem("cypress_wall_sign", () -> BlockRegistry.wallSign(SoundType.BAMBOO_WOOD, CYPRESS_SIGN, RuWoodTypes.CYPRESS));
    ...
    public static final Supplier<Block> CYPRESS_WALL_HANGING_SIGN = BlockRegistry.registerDefaultBlockNoItem("cypress_wall_hanging_sign", () -> BlockRegistry.wallHangingSign(MapColor.WOOD, SoundType.NETHER_WOOD, CYPRESS_HANGING_SIGN, RuWoodTypes.CYPRESS));
    //DEAD_BLOCKS
    ...
    public static final Supplier<Block> DEAD_WALL_SIGN = BlockRegistry.registerDefaultBlockNoItem("dead_wall_sign", () -> BlockRegistry.fireproofWallSign(SoundType.WOOD, DEAD_SIGN, RuWoodTypes.DEAD));
    ...
    public static final Supplier<Block> DEAD_WALL_HANGING_SIGN = BlockRegistry.registerDefaultBlockNoItem("dead_wall_hanging_sign", () -> BlockRegistry.fireproofWallHangingSign(MapColor.WOOD, SoundType.NETHER_WOOD, DEAD_HANGING_SIGN, RuWoodTypes.DEAD));
    //EUCALYPTUS_BLOCKS
    ...
    public static final Supplier<Block> EUCALYPTUS_WALL_SIGN = BlockRegistry.registerDefaultBlockNoItem("eucalyptus_wall_sign", () -> BlockRegistry.wallSign(SoundType.WOOD, EUCALYPTUS_SIGN, RuWoodTypes.EUCALYPTUS));
    ...
    public static final Supplier<Block> EUCALYPTUS_WALL_HANGING_SIGN = BlockRegistry.registerDefaultBlockNoItem("eucalyptus_wall_hanging_sign", () -> BlockRegistry.wallHangingSign(MapColor.WOOD, SoundType.NETHER_WOOD, EUCALYPTUS_HANGING_SIGN, RuWoodTypes.EUCALYPTUS));
    ...
    public static final Supplier<Block> GREEN_BIOSHROOM_WALL_SIGN = BlockRegistry.registerDefaultBlockNoItem("green_bioshroom_wall_sign", () -> BlockRegistry.wallSign(SoundType.NETHER_WOOD, GREEN_BIOSHROOM_SIGN, RuWoodTypes.GREEN_BIOSHROOM));
    ...
    public static final Supplier<Block> GREEN_BIOSHROOM_WALL_HANGING_SIGN = BlockRegistry.registerDefaultBlockNoItem("green_bioshroom_wall_hanging_sign", () -> BlockRegistry.wallHangingSign(MapColor.COLOR_LIGHT_GREEN, SoundType.NETHER_WOOD, GREEN_BIOSHROOM_HANGING_SIGN, RuWoodTypes.GREEN_BIOSHROOM));
    //JOSHUA_BLOCKS
    ...
    public static final Supplier<Block> JOSHUA_WALL_SIGN = BlockRegistry.registerDefaultBlockNoItem("joshua_wall_sign", () -> BlockRegistry.wallSign(SoundType.WOOD, JOSHUA_SIGN, RuWoodTypes.JOSHUA));
    ...
    public static final Supplier<Block> JOSHUA_WALL_HANGING_SIGN = BlockRegistry.registerDefaultBlockNoItem("joshua_wall_hanging_sign", () -> BlockRegistry.wallHangingSign(MapColor.WOOD, SoundType.NETHER_WOOD, JOSHUA_HANGING_SIGN, RuWoodTypes.JOSHUA));
    //KAPOK_BLOCKS
    ...
    public static final Supplier<Block> KAPOK_WALL_SIGN = BlockRegistry.registerDefaultBlockNoItem("kapok_wall_sign", () -> BlockRegistry.wallSign(SoundType.NETHER_WOOD, KAPOK_SIGN, RuWoodTypes.KAPOK));
    ...
    public static final Supplier<Block> KAPOK_WALL_HANGING_SIGN = BlockRegistry.registerDefaultBlockNoItem("kapok_wall_hanging_sign", () -> BlockRegistry.wallHangingSign(MapColor.TERRACOTTA_GREEN, SoundType.NETHER_WOOD, KAPOK_HANGING_SIGN, RuWoodTypes.KAPOK));
    //LARCH_BLOCKS
    ...
    public static final Supplier<Block> LARCH_WALL_SIGN = BlockRegistry.registerDefaultBlockNoItem("larch_wall_sign", () -> BlockRegistry.wallSign(SoundType.WOOD, LARCH_SIGN, RuWoodTypes.LARCH));
    ...
    public static final Supplier<Block> LARCH_WALL_HANGING_SIGN = BlockRegistry.registerDefaultBlockNoItem("larch_wall_hanging_sign", () -> BlockRegistry.wallHangingSign(MapColor.WOOD, SoundType.NETHER_WOOD, LARCH_HANGING_SIGN, RuWoodTypes.LARCH));
    //MAGNOLIA_BLOCKS
    ...
    public static final Supplier<Block> MAGNOLIA_WALL_SIGN = BlockRegistry.registerDefaultBlockNoItem("magnolia_wall_sign", () -> BlockRegistry.wallSign(SoundType.CHERRY_WOOD, MAGNOLIA_SIGN, RuWoodTypes.MAGNOLIA));
    ...
    public static final Supplier<Block> MAGNOLIA_WALL_HANGING_SIGN = BlockRegistry.registerDefaultBlockNoItem("magnolia_wall_hanging_sign", () -> BlockRegistry.wallHangingSign(MapColor.TERRACOTTA_PINK, SoundType.NETHER_WOOD, MAGNOLIA_HANGING_SIGN, RuWoodTypes.MAGNOLIA));
    //MAPLE_BLOCKS
    ...
    public static final Supplier<Block> MAPLE_WALL_SIGN = BlockRegistry.registerDefaultBlockNoItem("maple_wall_sign", () -> BlockRegistry.wallSign(SoundType.WOOD, MAPLE_SIGN, RuWoodTypes.MAPLE));
    ...
    public static final Supplier<Block> MAPLE_WALL_HANGING_SIGN = BlockRegistry.registerDefaultBlockNoItem("maple_wall_hanging_sign", () -> BlockRegistry.wallHangingSign(MapColor.WOOD, SoundType.NETHER_WOOD, MAPLE_HANGING_SIGN, RuWoodTypes.MAPLE));
    //MAUVE_BLOCKS
    ...
    public static final Supplier<Block> MAUVE_WALL_SIGN = BlockRegistry.registerDefaultBlockNoItem("mauve_wall_sign", () -> BlockRegistry.wallSign(SoundType.CHERRY_WOOD, MAUVE_SIGN, RuWoodTypes.MAUVE));
    ...
    public static final Supplier<Block> MAUVE_WALL_HANGING_SIGN = BlockRegistry.registerDefaultBlockNoItem("mauve_wall_hanging_sign", () -> BlockRegistry.wallHangingSign(MapColor.TERRACOTTA_PURPLE, SoundType.NETHER_WOOD, MAUVE_HANGING_SIGN, RuWoodTypes.MAUVE));
    //PALM_BLOCKS
    ...
    public static final Supplier<Block> PALM_WALL_SIGN = BlockRegistry.registerDefaultBlockNoItem("palm_wall_sign", () -> BlockRegistry.wallSign(SoundType.BAMBOO_WOOD, PALM_SIGN, RuWoodTypes.PALM));
    ...
    public static final Supplier<Block> PALM_WALL_HANGING_SIGN = BlockRegistry.registerDefaultBlockNoItem("palm_wall_hanging_sign", () -> BlockRegistry.wallHangingSign(MapColor.WOOD, SoundType.NETHER_WOOD, PALM_HANGING_SIGN, RuWoodTypes.PALM));
    //PINE_BLOCKS
    ...
    public static final Supplier<Block> PINE_WALL_SIGN = BlockRegistry.registerDefaultBlockNoItem("pine_wall_sign", () -> BlockRegistry.wallSign(SoundType.BAMBOO_WOOD, PINE_SIGN, RuWoodTypes.PINE));
    ...
    public static final Supplier<Block> PINE_WALL_HANGING_SIGN = BlockRegistry.registerDefaultBlockNoItem("pine_wall_hanging_sign", () -> BlockRegistry.wallHangingSign(MapColor.WOOD, SoundType.NETHER_WOOD, PINE_HANGING_SIGN, RuWoodTypes.PINE));
    ...
    public static final Supplier<Block> PINK_BIOSHROOM_WALL_SIGN = BlockRegistry.registerDefaultBlockNoItem("pink_bioshroom_wall_sign", () -> BlockRegistry.wallSign(SoundType.NETHER_WOOD, PINK_BIOSHROOM_SIGN, RuWoodTypes.PINK_BIOSHROOM));
    ...
    public static final Supplier<Block> PINK_BIOSHROOM_WALL_HANGING_SIGN = BlockRegistry.registerDefaultBlockNoItem("pink_bioshroom_wall_hanging_sign", () -> BlockRegistry.wallHangingSign(MapColor.COLOR_PINK, SoundType.NETHER_WOOD, PINK_BIOSHROOM_HANGING_SIGN, RuWoodTypes.PINK_BIOSHROOM));
    //REDWOOD_BLOCKS
    ...
    public static final Supplier<Block> REDWOOD_WALL_SIGN = BlockRegistry.registerDefaultBlockNoItem("redwood_wall_sign", () -> BlockRegistry.wallSign(SoundType.CHERRY_WOOD, REDWOOD_SIGN, RuWoodTypes.REDWOOD));
    ...
    public static final Supplier<Block> REDWOOD_WALL_HANGING_SIGN = BlockRegistry.registerDefaultBlockNoItem("redwood_wall_hanging_sign", () -> BlockRegistry.wallHangingSign(MapColor.TERRACOTTA_RED, SoundType.NETHER_WOOD, REDWOOD_HANGING_SIGN, RuWoodTypes.REDWOOD));
    //SILVER_BIRCH
    ...
    public static final Supplier<Block> SOCOTRA_WALL_SIGN = BlockRegistry.registerDefaultBlockNoItem("socotra_wall_sign", () -> BlockRegistry.wallSign(SoundType.CHERRY_WOOD, SOCOTRA_SIGN, RuWoodTypes.SOCOTRA));
    ...
    public static final Supplier<Block> SOCOTRA_WALL_HANGING_SIGN = BlockRegistry.registerDefaultBlockNoItem("socotra_wall_hanging_sign", () -> BlockRegistry.wallHangingSign(MapColor.TERRACOTTA_ORANGE, SoundType.NETHER_WOOD, SOCOTRA_HANGING_SIGN, RuWoodTypes.SOCOTRA));
    //WILLOW_BLOCKS
    ...
    public static final Supplier<Block> WILLOW_WALL_SIGN = BlockRegistry.registerDefaultBlockNoItem("willow_wall_sign", () -> BlockRegistry.wallSign(SoundType.WOOD, WILLOW_SIGN, RuWoodTypes.WILLOW));
    ...
    public static final Supplier<Block> WILLOW_WALL_HANGING_SIGN = BlockRegistry.registerDefaultBlockNoItem("willow_wall_hanging_sign", () -> BlockRegistry.wallHangingSign(MapColor.WOOD, SoundType.NETHER_WOOD, WILLOW_HANGING_SIGN, RuWoodTypes.WILLOW));
    ...
    public static final Supplier<Block> YELLOW_BIOSHROOM_WALL_SIGN = BlockRegistry.registerDefaultBlockNoItem("yellow_bioshroom_wall_sign", () -> BlockRegistry.fireproofWallSign(SoundType.NETHER_WOOD, YELLOW_BIOSHROOM_SIGN, RuWoodTypes.YELLOW_BIOSHROOM));
    ...
    public static final Supplier<Block> YELLOW_BIOSHROOM_WALL_HANGING_SIGN = BlockRegistry.registerDefaultBlockNoItem("yellow_bioshroom_wall_hanging_sign", () -> BlockRegistry.fireproofWallHangingSign(MapColor.COLOR_YELLOW, SoundType.NETHER_WOOD, YELLOW_BIOSHROOM_HANGING_SIGN, RuWoodTypes.YELLOW_BIOSHROOM));
    ...
    public static final Supplier<Block> GLISTERING_FERN = BlockRegistry.registerDefaultBlock("glistering_fern", () -> new RuNetherPlantBlock(BlockBehaviour.Properties.ofFullCopy(GLISTERING_SPROUT)));
    public static final Supplier<Block> GLISTERING_BLOOM = BlockRegistry.registerDefaultBlock("glistering_bloom", () -> new RuNetherPlantBlock(BlockBehaviour.Properties.ofFullCopy(GLISTERING_SPROUT)));
    ...
    /*-----------------POTTED_PLANTS-----------------*/
    //POTTED_FLOWERS
    public static final Supplier<Block> POTTED_ALPHA_DANDELION = BlockRegistry.registerDefaultBlockNoItem("potted_alpha_dandelion", () -> new FlowerPotBlock(ALPHA_DANDELION, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_ALPHA_ROSE = BlockRegistry.registerDefaultBlockNoItem("potted_alpha_rose", () -> new FlowerPotBlock(ALPHA_ROSE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_ASTER = BlockRegistry.registerDefaultBlockNoItem("potted_aster", () -> new FlowerPotBlock(ASTER, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_BLEEDING_HEART = BlockRegistry.registerDefaultBlockNoItem("potted_bleeding_heart", () -> new FlowerPotBlock(BLEEDING_HEART, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_BLUE_LUPINE = BlockRegistry.registerDefaultBlockNoItem("potted_blue_lupine", () -> new FlowerPotBlock(BLUE_LUPINE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_DAISY = BlockRegistry.registerDefaultBlockNoItem("potted_daisy", () -> new FlowerPotBlock(DAISY, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_DORCEL = BlockRegistry.registerDefaultBlockNoItem("potted_dorcel", () -> new FlowerPotBlock(DORCEL, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_FELICIA_DAISY = BlockRegistry.registerDefaultBlockNoItem("potted_felicia_daisy", () -> new FlowerPotBlock(FELICIA_DAISY, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_FIREWEED = BlockRegistry.registerDefaultBlockNoItem("potted_fireweed", () -> new FlowerPotBlock(FIREWEED, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_HIBISCUS = BlockRegistry.registerDefaultBlockNoItem("potted_hibiscus", () -> new FlowerPotBlock(HIBISCUS, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_HYSSOP = BlockRegistry.registerDefaultBlockNoItem("potted_hyssop", () -> new FlowerPotBlock(HYSSOP, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_MALLOW = BlockRegistry.registerDefaultBlockNoItem("potted_mallow", () -> new FlowerPotBlock(MALLOW, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_PINK_LUPINE = BlockRegistry.registerDefaultBlockNoItem("potted_pink_lupine", () -> new FlowerPotBlock(PINK_LUPINE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_POPPY_BUSH = BlockRegistry.registerDefaultBlockNoItem("potted_poppy_bush", () -> new FlowerPotBlock(POPPY_BUSH, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_SALMON_POPPY_BUSH = BlockRegistry.registerDefaultBlockNoItem("potted_salmon_poppy_bush", () -> new FlowerPotBlock(SALMON_POPPY_BUSH, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_PURPLE_LUPINE = BlockRegistry.registerDefaultBlockNoItem("potted_purple_lupine", () -> new FlowerPotBlock(PURPLE_LUPINE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_RED_LUPINE = BlockRegistry.registerDefaultBlockNoItem("potted_red_lupine", () -> new FlowerPotBlock(RED_LUPINE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_TSUBAKI = BlockRegistry.registerDefaultBlockNoItem("potted_tsubaki", () -> new FlowerPotBlock(TSUBAKI, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_ORANGE_CONEFLOWER = BlockRegistry.registerDefaultBlockNoItem("potted_orange_coneflower", () -> new FlowerPotBlock(ORANGE_CONEFLOWER, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_PURPLE_CONEFLOWER = BlockRegistry.registerDefaultBlockNoItem("potted_purple_coneflower", () -> new FlowerPotBlock(PURPLE_CONEFLOWER, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_WARATAH = BlockRegistry.registerDefaultBlockNoItem("potted_waratah", () -> new FlowerPotBlock(WARATAH, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_WHITE_TRILLIUM = BlockRegistry.registerDefaultBlockNoItem("potted_white_trillium", () -> new FlowerPotBlock(WHITE_TRILLIUM, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_WILTING_TRILLIUM = BlockRegistry.registerDefaultBlockNoItem("potted_wilting_trillium", () -> new FlowerPotBlock(WILTING_TRILLIUM, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_YELLOW_LUPINE = BlockRegistry.registerDefaultBlockNoItem("potted_yellow_lupine", () -> new FlowerPotBlock(YELLOW_LUPINE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_GLISTERING_BLOOM = BlockRegistry.registerDefaultBlockNoItem("potted_glistering_bloom", () -> new FlowerPotBlock(GLISTERING_BLOOM, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    //OTHER_POTS
    public static final Supplier<Block> POTTED_DAY_LILY = BlockRegistry.registerDefaultBlockNoItem("potted_day_lily", () -> new FlowerPotBlock(DAY_LILY, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_MEADOW_SAGE = BlockRegistry.registerDefaultBlockNoItem("potted_meadow_sage", () -> new FlowerPotBlock(MEADOW_SAGE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_DUSKTRAP = BlockRegistry.registerDefaultBlockNoItem("potted_dusktrap", () -> new FlowerPotBlock(DUSKTRAP, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_CORPSE_FLOWER = BlockRegistry.registerDefaultBlockNoItem("potted_corpse_flower", () -> new FlowerPotBlock(CORPSE_FLOWER, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_COBALT_EARLIGHT = BlockRegistry.registerDefaultBlockNoItem("potted_cobalt_earlight", () -> new FlowerPotBlock(COBALT_EARLIGHT, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM).lightLevel(s -> 8)));
    public static final Supplier<Block> POTTED_TALL_COBALT_EARLIGHT = BlockRegistry.registerDefaultBlockNoItem("potted_tall_cobalt_earlight", () -> new FlowerPotBlock(TALL_COBALT_EARLIGHT, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM).lightLevel(s -> 8)));
    public static final Supplier<Block> POTTED_MYCOTOXIC_DAISY = BlockRegistry.registerDefaultBlockNoItem("potted_mycotoxic_daisy", () -> new FlowerPotBlock(MYCOTOXIC_DAISY, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM).lightLevel(s -> 8)));
    public static final Supplier<Block> POTTED_GLISTER_SPIRE = BlockRegistry.registerDefaultBlockNoItem("potted_glister_spire", () -> new FlowerPotBlock(GLISTER_SPIRE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    //POTTED_SAPLINGS
    public static final Supplier<Block> POTTED_ASHEN_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_ashen_sapling", () -> new FlowerPotBlock(ASHEN_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_ALPHA_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_alpha_sapling", () -> new FlowerPotBlock(ALPHA_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_APPLE_OAK_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_apple_oak_sapling", () -> new FlowerPotBlock(APPLE_OAK_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_BAMBOO_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_bamboo_sapling", () -> new FlowerPotBlock(BAMBOO_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_BAOBAB_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_baobab_sapling", () -> new FlowerPotBlock(BAOBAB_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_BLACKWOOD_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_blackwood_sapling", () -> new FlowerPotBlock(BLACKWOOD_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_CACTUS_FLOWER = BlockRegistry.registerDefaultBlockNoItem("potted_cactus_flower", () -> new FlowerPotBlock(CACTUS_FLOWER, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_MAGNOLIA_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_magnolia_sapling", () -> new FlowerPotBlock(MAGNOLIA_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_CYPRESS_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_cypress_sapling", () -> new FlowerPotBlock(CYPRESS_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_DEAD_PINE_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_dead_pine_sapling", () -> new FlowerPotBlock(DEAD_PINE_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_DEAD_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_dead_sapling", () -> new FlowerPotBlock(DEAD_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_EUCALYPTUS_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_eucalyptus_sapling", () -> new FlowerPotBlock(EUCALYPTUS_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_FLOWERING_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_flowering_sapling", () -> new FlowerPotBlock(FLOWERING_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_GOLDEN_LARCH_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_golden_larch_sapling", () -> new FlowerPotBlock(GOLDEN_LARCH_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_JOSHUA_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_joshua_sapling", () -> new FlowerPotBlock(JOSHUA_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_KAPOK_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_kapok_sapling", () -> new FlowerPotBlock(KAPOK_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_LARCH_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_larch_sapling", () -> new FlowerPotBlock(LARCH_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_MAPLE_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_maple_sapling", () -> new FlowerPotBlock(MAPLE_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_MAUVE_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_mauve_sapling", () -> new FlowerPotBlock(MAUVE_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_ORANGE_MAPLE_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_orange_maple_sapling", () -> new FlowerPotBlock(ORANGE_MAPLE_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_PALM_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_palm_sapling", () -> new FlowerPotBlock(PALM_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_PINE_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_pine_sapling", () -> new FlowerPotBlock(PINE_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_BLUE_MAGNOLIA_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_blue_magnolia_sapling", () -> new FlowerPotBlock(BLUE_MAGNOLIA_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_PINK_MAGNOLIA_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_pink_magnolia_sapling", () -> new FlowerPotBlock(PINK_MAGNOLIA_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_REDWOOD_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_redwood_sapling", () -> new FlowerPotBlock(REDWOOD_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_RED_MAPLE_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_red_maple_sapling", () -> new FlowerPotBlock(RED_MAPLE_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_BRIMWOOD_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_brimwood_sapling", () -> new FlowerPotBlock(BRIMWOOD_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_COBALT_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_cobalt_sapling", () -> new FlowerPotBlock(COBALT_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_ENCHANTED_BIRCH_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_enchanted_birch_sapling", () -> new FlowerPotBlock(ENCHANTED_BIRCH_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_SMALL_OAK_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_small_oak_sapling", () -> new FlowerPotBlock(SMALL_OAK_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_SILVER_BIRCH_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_silver_birch_sapling", () -> new FlowerPotBlock(SILVER_BIRCH_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_SOCOTRA_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_socotra_sapling", () -> new FlowerPotBlock(SOCOTRA_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_WHITE_MAGNOLIA_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_white_magnolia_sapling", () -> new FlowerPotBlock(WHITE_MAGNOLIA_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    public static final Supplier<Block> POTTED_WILLOW_SAPLING = BlockRegistry.registerDefaultBlockNoItem("potted_willow_sapling", () -> new FlowerPotBlock(WILLOW_SAPLING, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_OAK_SAPLING)));
    //POTTED_MUSHROOMS
    public static final Supplier<Block> POTTED_BLUE_BIOSHROOM = BlockRegistry.registerDefaultBlockNoItem("potted_blue_bioshroom", () -> new FlowerPotBlock(BLUE_BIOSHROOM, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_BROWN_MUSHROOM).lightLevel(s -> 10)));
    public static final Supplier<Block> POTTED_GREEN_BIOSHROOM = BlockRegistry.registerDefaultBlockNoItem("potted_green_bioshroom", () -> new FlowerPotBlock(GREEN_BIOSHROOM, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_BROWN_MUSHROOM).lightLevel(s -> 10)));
    public static final Supplier<Block> POTTED_PINK_BIOSHROOM = BlockRegistry.registerDefaultBlockNoItem("potted_pink_bioshroom", () -> new FlowerPotBlock(PINK_BIOSHROOM, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_BROWN_MUSHROOM).lightLevel(s -> 10)));
    public static final Supplier<Block> POTTED_YELLOW_BIOSHROOM = BlockRegistry.registerDefaultBlockNoItem("potted_yellow_bioshroom", () -> new FlowerPotBlock(YELLOW_BIOSHROOM, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_BROWN_MUSHROOM).lightLevel(s -> 10)));
    public static final Supplier<Block> POTTED_TALL_BLUE_BIOSHROOM = BlockRegistry.registerDefaultBlockNoItem("potted_tall_blue_bioshroom", () -> new FlowerPotBlock(TALL_BLUE_BIOSHROOM, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_BROWN_MUSHROOM).lightLevel(s -> 10)));
    public static final Supplier<Block> POTTED_TALL_GREEN_BIOSHROOM = BlockRegistry.registerDefaultBlockNoItem("potted_tall_green_bioshroom", () -> new FlowerPotBlock(TALL_GREEN_BIOSHROOM, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_BROWN_MUSHROOM).lightLevel(s -> 10)));
    public static final Supplier<Block> POTTED_TALL_PINK_BIOSHROOM = BlockRegistry.registerDefaultBlockNoItem("potted_tall_pink_bioshroom", () -> new FlowerPotBlock(TALL_PINK_BIOSHROOM, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_BROWN_MUSHROOM).lightLevel(s -> 10)));
    public static final Supplier<Block> POTTED_TALL_YELLOW_BIOSHROOM = BlockRegistry.registerDefaultBlockNoItem("potted_tall_yellow_bioshroom", () -> new FlowerPotBlock(TALL_YELLOW_BIOSHROOM, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_BROWN_MUSHROOM).lightLevel(s -> 10)));
    //OTHER_POTTED_PLANTS
    public static final Supplier<Block> POTTED_BARREL_CACTUS = BlockRegistry.registerDefaultBlockNoItem("potted_barrel_cactus", () -> new FlowerPotBlock(BARREL_CACTUS, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_CACTUS)));
    public static final Supplier<Block> POTTED_CAVE_HYSSOP = BlockRegistry.registerDefaultBlockNoItem("potted_cave_hyssop", () -> new FlowerPotBlock(CAVE_HYSSOP, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    //POTTED_SNOWBELLE
    public static final Supplier<Block> POTTED_RED_SNOWBELLE = BlockRegistry.registerDefaultBlockNoItem("potted_red_snowbelle", () -> new FlowerPotBlock(RED_SNOWBELLE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_ORANGE_SNOWBELLE = BlockRegistry.registerDefaultBlockNoItem("potted_orange_snowbelle", () -> new FlowerPotBlock(ORANGE_SNOWBELLE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_YELLOW_SNOWBELLE = BlockRegistry.registerDefaultBlockNoItem("potted_yellow_snowbelle", () -> new FlowerPotBlock(YELLOW_SNOWBELLE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_LIME_SNOWBELLE = BlockRegistry.registerDefaultBlockNoItem("potted_lime_snowbelle", () -> new FlowerPotBlock(LIME_SNOWBELLE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_GREEN_SNOWBELLE = BlockRegistry.registerDefaultBlockNoItem("potted_green_snowbelle", () -> new FlowerPotBlock(GREEN_SNOWBELLE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_CYAN_SNOWBELLE = BlockRegistry.registerDefaultBlockNoItem("potted_cyan_snowbelle", () -> new FlowerPotBlock(CYAN_SNOWBELLE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_LIGHT_BLUE_SNOWBELLE = BlockRegistry.registerDefaultBlockNoItem("potted_light_blue_snowbelle", () -> new FlowerPotBlock(LIGHT_BLUE_SNOWBELLE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_BLUE_SNOWBELLE = BlockRegistry.registerDefaultBlockNoItem("potted_blue_snowbelle", () -> new FlowerPotBlock(BLUE_SNOWBELLE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_PURPLE_SNOWBELLE = BlockRegistry.registerDefaultBlockNoItem("potted_purple_snowbelle", () -> new FlowerPotBlock(PURPLE_SNOWBELLE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_MAGENTA_SNOWBELLE = BlockRegistry.registerDefaultBlockNoItem("potted_magenta_snowbelle", () -> new FlowerPotBlock(MAGENTA_SNOWBELLE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_PINK_SNOWBELLE = BlockRegistry.registerDefaultBlockNoItem("potted_pink_snowbelle", () -> new FlowerPotBlock(PINK_SNOWBELLE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_BROWN_SNOWBELLE = BlockRegistry.registerDefaultBlockNoItem("potted_brown_snowbelle", () -> new FlowerPotBlock(BROWN_SNOWBELLE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_WHITE_SNOWBELLE = BlockRegistry.registerDefaultBlockNoItem("potted_white_snowbelle", () -> new FlowerPotBlock(WHITE_SNOWBELLE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_LIGHT_GRAY_SNOWBELLE = BlockRegistry.registerDefaultBlockNoItem("potted_light_gray_snowbelle", () -> new FlowerPotBlock(LIGHT_GRAY_SNOWBELLE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_GRAY_SNOWBELLE = BlockRegistry.registerDefaultBlockNoItem("potted_gray_snowbelle", () -> new FlowerPotBlock(GRAY_SNOWBELLE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
    public static final Supplier<Block> POTTED_BLACK_SNOWBELLE = BlockRegistry.registerDefaultBlockNoItem("potted_black_snowbelle", () -> new FlowerPotBlock(BLACK_SNOWBELLE, BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_ALLIUM)));
