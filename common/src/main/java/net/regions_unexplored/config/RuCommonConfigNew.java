...
public class RuCommonConfigNew extends Config {
    @ConfigOption(category = "region_configs", comment = "Enable this before changing the other region config files. If disabled, RU will use builtin biome placement.")
    ...
    @ConfigOption(category = "region_configs", comment = "Sets Terrablender region weight for the primary region.")
    public static final ConfigValue<Integer> REGION_PRIMARY_WEIGHT = integer(11);
    @Range(min = 0, max = 2147483646)
    @RequiresRestart(RequiresRestart.RestartType.GAME)
    @ConfigOption(category = "region_configs", comment = "Sets Terrablender region weight for the secondary region.")
    public static final ConfigValue<Integer> REGION_SECONDARY_WEIGHT = integer(8);
    @Range(min = 0, max = 2147483646)
    @RequiresRestart(RequiresRestart.RestartType.GAME)
    @ConfigOption(category = "region_configs", comment = "Sets Terrablender region weight for the rare region.")
    public static final ConfigValue<Integer> REGION_RARE_WEIGHT = integer(1);
    @Range(min = 0, max = 2147483646)
    @RequiresRestart(RequiresRestart.RestartType.GAME)
    @ConfigOption(category = "region_configs", comment = "Sets Terrablender region weight for Nether region.")
    public static final ConfigValue<Integer> REGION_NETHER_WEIGHT = integer(14);

    @ConfigOption(category = "biome_toggles.overworld_biomes")
    ...
    @ConfigOption(category = "biome_toggles.cave_biomes")
    ...
    @ConfigOption(category = "biome_toggles.nether_biomes")
    ...
    @ConfigOption(category = "worldgen_options.surface_rules")
