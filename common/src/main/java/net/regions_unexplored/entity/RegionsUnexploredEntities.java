...
public class RegionsUnexploredEntities {
    ...
    public static EntityType<?> BOAT = registerEntity("boat",
            EntityType.Builder.<RuBoat>of(RuBoat::new, MobCategory.MISC).sized(1.375F, 0.5625F)
                    .clientTrackingRange(10).build("boat"));


    public static EntityType<?> CHEST_BOAT = registerEntity("chest_boat",
    ...
    private static EntityType<?> registerEntity(String path, EntityType<?> type) {
