...
public class EucalyptusTreeFeature extends Feature<RuTreeConfiguration> {

    public EucalyptusTreeFeature(Codec<RuTreeConfiguration> codec) {
        super(codec);
    }
    ...
    public void placeTop(LevelAccessor level, BlockPos pos, RandomSource randomSource, RuTreeConfiguration treeConfiguration) {
        ...
        placeLeavesBlock(level,placePos,randomSource,treeConfiguration);
        placePos.move(Direction.DOWN);
        placeLeavesBlock(level,placePos,randomSource,treeConfiguration);
        placeLeavesBlock(level,placePos.north(),randomSource,treeConfiguration);
        if(randomSource.nextInt(2)==0) {
        ...
        placeLeavesBlock(level,placePos.south(),randomSource,treeConfiguration);
        if(randomSource.nextInt(2)==0) {
        ...
        placeLeavesBlock(level,placePos.east(),randomSource,treeConfiguration);
        placeLeavesBlock(level,placePos.west(),randomSource,treeConfiguration);

        placePos.move(Direction.DOWN);
        placeLeavesBlobMed(level,placePos,randomSource,treeConfiguration);
        placePos.move(Direction.DOWN);
        placeLeavesBlobLarge(level,placePos,randomSource,treeConfiguration);
        placePos.move(Direction.DOWN);
        placeLeavesBlobMed(level,placePos,randomSource,treeConfiguration);
        placePos.move(Direction.DOWN);
        placeLeavesBlobSmall(level,placePos,randomSource,treeConfiguration);
        placePos.move(Direction.DOWN);
    ...
    public boolean placeLeavesBlobLarge(LevelAccessor level, BlockPos pos, RandomSource randomSource, RuTreeConfiguration treeConfiguration) {
        ...
        placeLeavesBlock(level, pos.east().east().east().north(), randomSource, treeConfiguration);
        placeLeavesBlock(level, pos.east().east().east().north().north(), randomSource, treeConfiguration);
        placeLeavesBlock(level, pos.east().east().east().south(), randomSource, treeConfiguration);
        placeLeavesBlock(level, pos.east().east().east().south().south(), randomSource, treeConfiguration);

        placeLeavesBlock(level, pos.west().west().west(), randomSource, treeConfiguration);
        placeLeavesBlock(level, pos.west().west().west().north(), randomSource, treeConfiguration);
        placeLeavesBlock(level, pos.west().west().west().north().north(), randomSource, treeConfiguration);
        placeLeavesBlock(level, pos.west().west().west().south(), randomSource, treeConfiguration);
        placeLeavesBlock(level, pos.west().west().west().south().south(), randomSource, treeConfiguration);
        return true;
    }
    ...
    public static boolean isReplaceableDirt(LevelSimulatedReader reader, BlockPos pos) {
        return reader.isStateAtPosition(pos, EucalyptusTreeFeature::isReplaceableDirtBlock);
    }
    ...
    public static boolean isReplaceable(LevelSimulatedReader reader, BlockPos pos) {
        return reader.isStateAtPosition(pos, EucalyptusTreeFeature::isReplaceableBlock);
    }
}