...
public class LarchTreeFeature extends Feature<RuTreeConfiguration> {

    public LarchTreeFeature(Codec<RuTreeConfiguration> codec) {
        super(codec);
    }
    ...
    public static boolean isReplaceableDirt(LevelSimulatedReader reader, BlockPos pos) {
        return reader.isStateAtPosition(pos, LarchTreeFeature::isReplaceableDirtBlock);
    }
    ...
    public static boolean isReplaceable(LevelSimulatedReader reader, BlockPos pos) {
        return reader.isStateAtPosition(pos, LarchTreeFeature::isReplaceableBlock);
    }
}