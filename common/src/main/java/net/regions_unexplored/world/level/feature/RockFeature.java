...
public class RockFeature extends Feature<NoneFeatureConfiguration> {
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        placeBottom(level, pos, randomSource);
        placeBottom(level, pos.north(), randomSource);
        placeBottom(level, pos.north().east(), randomSource);
        placeBottom(level, pos.east(), randomSource);
        return true;
    }
    ...
    public boolean placeBottom(LevelAccessor level, BlockPos pos, RandomSource randomSource) {
        ...
        while(i<=rd){
            placeStoneBlock(level, placePos, randomSource);
    ...
    public static boolean isReplaceableDirt(LevelSimulatedReader reader, BlockPos pos) {
        return reader.isStateAtPosition(pos, RockFeature::isReplaceableDirtBlock);
    }
    ...
    public static boolean isReplaceable(LevelSimulatedReader reader, BlockPos pos) {
        return reader.isStateAtPosition(pos, RockFeature::isReplaceableBlock);
    }
}