...
public class LargeSocotraTreeFeature extends Feature<RuTreeConfiguration> {
    ...
    public void placeTop(LevelAccessor level, BlockPos pos, RandomSource randomSource, RuTreeConfiguration treeConfiguration) {
        BlockPos.MutableBlockPos placePos = new BlockPos.MutableBlockPos(pos.getX(),pos.getY()-1,pos.getZ());

        placeLeavesBlob(level,pos,randomSource,treeConfiguration);

        placeLog(level,placePos.north(),randomSource,treeConfiguration,Direction.Axis.Z);
        placeLog(level,placePos.north(2),randomSource,treeConfiguration,Direction.Axis.Z);
        placeLeavesBlob(level,placePos.north(2),randomSource,treeConfiguration);

        placeLog(level,placePos.south(),randomSource,treeConfiguration,Direction.Axis.Z);
        placeLog(level,placePos.south(2),randomSource,treeConfiguration,Direction.Axis.Z);
        placeLeavesBlob(level,placePos.south(2),randomSource,treeConfiguration);

        placeLog(level,placePos.east(),randomSource,treeConfiguration,Direction.Axis.X);
        placeLog(level,placePos.east(2),randomSource,treeConfiguration,Direction.Axis.X);
        placeLeavesBlob(level,placePos.east(2),randomSource,treeConfiguration);

        placeLog(level,placePos.west(),randomSource,treeConfiguration,Direction.Axis.X);
        placeLog(level,placePos.west(2),randomSource,treeConfiguration,Direction.Axis.X);
        placeLeavesBlob(level,placePos.west(2),randomSource,treeConfiguration);

        placePos.move(Direction.DOWN);

        placeLog(level,placePos.north(2).east(2),randomSource,treeConfiguration,Direction.Axis.Z);
        placeLeavesBlob(level,placePos.north(2).east(2),randomSource,treeConfiguration);

        placeLog(level,placePos.north(2).west(2),randomSource,treeConfiguration,Direction.Axis.X);
        placeLeavesBlob(level,placePos.north(2).west(2),randomSource,treeConfiguration);

        placeLog(level,placePos.south(2).east(2),randomSource,treeConfiguration,Direction.Axis.X);
        placeLeavesBlob(level,placePos.south(2).east(2),randomSource,treeConfiguration);

        placeLog(level,placePos.south(2).west(2),randomSource,treeConfiguration,Direction.Axis.Z);
        placeLeavesBlob(level,placePos.south(2).west(2),randomSource,treeConfiguration);

        placePos.move(Direction.DOWN);

        placeLog(level,placePos.north().east(),randomSource,treeConfiguration,Direction.Axis.Z);
        placeLog(level,placePos.north().west(),randomSource,treeConfiguration,Direction.Axis.X);
        placeLog(level,placePos.south().east(),randomSource,treeConfiguration,Direction.Axis.X);
        placeLog(level,placePos.south().west(),randomSource,treeConfiguration,Direction.Axis.Z);


        placeLog(level,placePos.north(3),randomSource,treeConfiguration,Direction.Axis.Z);
        placeLog(level,placePos.north(4),randomSource,treeConfiguration,Direction.Axis.Z);
        placeLeavesBlob(level,placePos.north(4),randomSource,treeConfiguration);

        placeLog(level,placePos.north(3).east(),randomSource,treeConfiguration,Direction.Axis.X);
        placeLeavesBlob(level,placePos.north(3).east(),randomSource,treeConfiguration);
        placeLog(level,placePos.north(3).west(),randomSource,treeConfiguration,Direction.Axis.X);
        placeLeavesBlob(level,placePos.north(3).west(),randomSource,treeConfiguration);


        placeLog(level,placePos.south(3),randomSource,treeConfiguration,Direction.Axis.Z);
        placeLog(level,placePos.south(4),randomSource,treeConfiguration,Direction.Axis.Z);
        placeLeavesBlob(level,placePos.south(4),randomSource,treeConfiguration);

        placeLog(level,placePos.south(3).east(),randomSource,treeConfiguration,Direction.Axis.X);
        placeLeavesBlob(level,placePos.south(3).east(),randomSource,treeConfiguration);
        placeLog(level,placePos.south(3).west(),randomSource,treeConfiguration,Direction.Axis.X);
        placeLeavesBlob(level,placePos.south(3).west(),randomSource,treeConfiguration);


        placeLog(level,placePos.east(3),randomSource,treeConfiguration,Direction.Axis.X);
        placeLog(level,placePos.east(4),randomSource,treeConfiguration,Direction.Axis.X);
        placeLeavesBlob(level,placePos.east(4),randomSource,treeConfiguration);

        placeLog(level,placePos.east(3).north(),randomSource,treeConfiguration,Direction.Axis.Z);
        placeLeavesBlob(level,placePos.east(3).north(),randomSource,treeConfiguration);
        placeLog(level,placePos.east(3).south(),randomSource,treeConfiguration,Direction.Axis.Z);
        placeLeavesBlob(level,placePos.east(3).south(),randomSource,treeConfiguration);


        placeLog(level,placePos.west(3),randomSource,treeConfiguration,Direction.Axis.X);
        placeLog(level,placePos.west(4),randomSource,treeConfiguration,Direction.Axis.X);
        placeLeavesBlob(level,placePos.west(4),randomSource,treeConfiguration);

        placeLog(level,placePos.west(3).north(),randomSource,treeConfiguration,Direction.Axis.Z);
        placeLeavesBlob(level,placePos.west(3).north(),randomSource,treeConfiguration);
        placeLog(level,placePos.west(3).south(),randomSource,treeConfiguration,Direction.Axis.Z);
        placeLeavesBlob(level,placePos.west(3).south(),randomSource,treeConfiguration);
    ...
    public static boolean isReplaceableDirt(LevelSimulatedReader reader, BlockPos pos) {
        return reader.isStateAtPosition(pos, LargeSocotraTreeFeature::isReplaceableDirtBlock);
    }
    ...
    public static boolean isReplaceable(LevelSimulatedReader reader, BlockPos pos) {
        return reader.isStateAtPosition(pos, LargeSocotraTreeFeature::isReplaceableBlock);
    }
}