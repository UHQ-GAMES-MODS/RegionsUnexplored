...
public class MegaBaobabTreeFeature extends Feature<RuTreeConfiguration> {

    public MegaBaobabTreeFeature(Codec<RuTreeConfiguration> codec) {
        super(codec);
    }
    ...
    public void placeTop(LevelAccessor level, BlockPos pos, RandomSource randomSource, RuTreeConfiguration treeConfiguration) {
        ...
        placeLog(level,pos1,randomSource,treeConfiguration,Direction.Axis.Y);
        placeBranch(level,pos1,randomSource,treeConfiguration,Direction.WEST);
        ...
        placeLog(level,pos1.north().east(),randomSource,treeConfiguration,Direction.Axis.Y);
        placeBranch(level,pos1.north().east(),randomSource,treeConfiguration,Direction.EAST);

        placeLog(level,pos1.east(),randomSource,treeConfiguration,Direction.Axis.Y);
        placeBranch(level,pos1.east(),randomSource,treeConfiguration,Direction.SOUTH);
    }
    ...
    public static boolean isReplaceableDirt(LevelSimulatedReader reader, BlockPos pos) {
        return reader.isStateAtPosition(pos, MegaBaobabTreeFeature::isReplaceableDirtBlock);
    }
    ...
    public static boolean isReplaceable(LevelSimulatedReader reader, BlockPos pos) {
        return reader.isStateAtPosition(pos, MegaBaobabTreeFeature::isReplaceableBlock);
    }
}