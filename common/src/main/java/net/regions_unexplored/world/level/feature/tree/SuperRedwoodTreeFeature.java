...
public class SuperRedwoodTreeFeature extends Feature<RuTreeConfiguration> {

    public SuperRedwoodTreeFeature(Codec<RuTreeConfiguration> codec) {
        super(codec);
    }
    ...
    public static boolean isReplaceableDirt(LevelSimulatedReader reader, BlockPos pos) {
        return reader.isStateAtPosition(pos, SuperRedwoodTreeFeature::isReplaceableDirtBlock);
    }
    ...
    public static boolean isReplaceable(LevelSimulatedReader reader, BlockPos pos) {
        return reader.isStateAtPosition(pos, SuperRedwoodTreeFeature::isReplaceableBlock);
    }
}