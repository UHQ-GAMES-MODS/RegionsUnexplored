...
public class RuBlockCropCutouts {
    public static void init() {
        RenderUtil.putBlocks(Services.RENDER_HELPER, RenderType.cutout(),
                ...
                RuBlocks.ALPHA_NATURAL_SET.getSapling(),
                RuBlocks.APPLE_OAK_NATURAL_SET.getSapling(),
                RuBlocks.BAMBOO_NATURAL_SET.getSapling(),
                RuBlocks.BAOBAB_NATURAL_SET.getSapling(),
                RuBlocks.BLACKWOOD_NATURAL_SET.getSapling(),
                RuBlocks.BRIMWOOD_NATURAL_SET.getSapling(),
                RuBlocks.COBALT_SAPLING.get(),
                RuBlocks.CACTUS_FLOWER.get(),
                RuBlocks.CYPRESS_NATURAL_SET.getSapling(),
                RuBlocks.DEAD_PINE_NATURAL_SET.getSapling(),
                RuBlocks.DEAD_NATURAL_SET.getSapling(),
                RuBlocks.EUCALYPTUS_NATURAL_SET.getSapling(),
                RuBlocks.FLOWERING_NATURAL_SET.getSapling(),
                RuBlocks.GOLDEN_LARCH_NATURAL_SET.getSapling(),
                RuBlocks.JOSHUA_NATURAL_SET.getSapling(),
                RuBlocks.KAPOK_NATURAL_SET.getSapling(),
                RuBlocks.LARCH_NATURAL_SET.getSapling(),
                RuBlocks.MAGNOLIA_NATURAL_SET.getSapling(),
                RuBlocks.MAPLE_NATURAL_SET.getSapling(),
                RuBlocks.MAUVE_NATURAL_SET.getSapling(),
                RuBlocks.ORANGE_MAPLE_NATURAL_SET.getSapling(),
                RuBlocks.PALM_NATURAL_SET.getSapling(),
                RuBlocks.PINE_NATURAL_SET.getSapling(),
                RuBlocks.BLUE_MAGNOLIA_NATURAL_SET.getSapling(),
                RuBlocks.PINK_MAGNOLIA_NATURAL_SET.getSapling(),
                RuBlocks.REDWOOD_NATURAL_SET.getSapling(),
                RuBlocks.RED_MAPLE_NATURAL_SET.getSapling(),
                RuBlocks.ENCHANTED_BIRCH_NATURAL_SET.getSapling(),
                RuBlocks.SILVER_BIRCH_NATURAL_SET.getSapling(),
                RuBlocks.SMALL_OAK_NATURAL_SET.getSapling(),
                RuBlocks.SOCOTRA_NATURAL_SET.getSapling(),
                RuBlocks.WHITE_MAGNOLIA_NATURAL_SET.getSapling(),
                RuBlocks.WILLOW_NATURAL_SET.getSapling(),
                //SHRUBS
                RuBlocks.ACACIA_NATURAL_SET.getShrub(),
                RuBlocks.BAOBAB_NATURAL_SET.getShrub(),
                RuBlocks.BIRCH_NATURAL_SET.getShrub(),
                RuBlocks.BLACKWOOD_NATURAL_SET.getShrub(),
                RuBlocks.BRIMWOOD_NATURAL_SET.getShrub(),
                RuBlocks.CHERRY_NATURAL_SET.getShrub(),
                RuBlocks.CYPRESS_NATURAL_SET.getShrub(),
                RuBlocks.DARK_OAK_NATURAL_SET.getShrub(),
                RuBlocks.DEAD_PINE_NATURAL_SET.getShrub(),
                RuBlocks.DEAD_NATURAL_SET.getShrub(),
                RuBlocks.EUCALYPTUS_NATURAL_SET.getShrub(),
                RuBlocks.FLOWERING_NATURAL_SET.getShrub(),
                RuBlocks.GOLDEN_LARCH_NATURAL_SET.getShrub(),
                RuBlocks.JOSHUA_NATURAL_SET.getShrub(),
                RuBlocks.JUNGLE_NATURAL_SET.getShrub(),
                RuBlocks.KAPOK_NATURAL_SET.getShrub(),
                RuBlocks.LARCH_NATURAL_SET.getShrub(),
                RuBlocks.MAGNOLIA_NATURAL_SET.getShrub(),
                RuBlocks.MANGROVE_NATURAL_SET.getShrub(),
                RuBlocks.MAPLE_NATURAL_SET.getShrub(),
                RuBlocks.MAUVE_NATURAL_SET.getShrub(),
                RuBlocks.OAK_NATURAL_SET.getShrub(),
                RuBlocks.ORANGE_MAPLE_NATURAL_SET.getShrub(),
                RuBlocks.PALM_NATURAL_SET.getShrub(),
                RuBlocks.PINE_NATURAL_SET.getShrub(),
                RuBlocks.BLUE_MAGNOLIA_NATURAL_SET.getShrub(),
                RuBlocks.PINK_MAGNOLIA_NATURAL_SET.getShrub(),
                RuBlocks.REDWOOD_NATURAL_SET.getShrub(),
                RuBlocks.RED_MAPLE_NATURAL_SET.getShrub(),
                RuBlocks.ENCHANTED_BIRCH_NATURAL_SET.getShrub(),
                RuBlocks.SILVER_BIRCH_NATURAL_SET.getShrub(),
                RuBlocks.SOCOTRA_NATURAL_SET.getShrub(),
                RuBlocks.SPRUCE_NATURAL_SET.getShrub(),
                RuBlocks.WHITE_MAGNOLIA_NATURAL_SET.getShrub(),
                RuBlocks.WILLOW_NATURAL_SET.getShrub(),
                //MUSHROOMS
                ...
                RuBlocks.ALPHA_NATURAL_SET.getPottedSapling(),
                RuBlocks.APPLE_OAK_NATURAL_SET.getPottedSapling(),
                RuBlocks.BAMBOO_NATURAL_SET.getPottedSapling(),
                RuBlocks.BAOBAB_NATURAL_SET.getPottedSapling(),
                RuBlocks.BLACKWOOD_NATURAL_SET.getPottedSapling(),
                RuBlocks.BRIMWOOD_NATURAL_SET.getPottedSapling(),
                RuBlocks.POTTED_COBALT_SAPLING.get(),
                RuBlocks.POTTED_CACTUS_FLOWER.get(),
                RuBlocks.MAGNOLIA_NATURAL_SET.getPottedSapling(),
                RuBlocks.CYPRESS_NATURAL_SET.getPottedSapling(),
                RuBlocks.DEAD_PINE_NATURAL_SET.getPottedSapling(),
                RuBlocks.DEAD_NATURAL_SET.getPottedSapling(),
                RuBlocks.EUCALYPTUS_NATURAL_SET.getPottedSapling(),
                RuBlocks.FLOWERING_NATURAL_SET.getPottedSapling(),
                RuBlocks.GOLDEN_LARCH_NATURAL_SET.getPottedSapling(),
                RuBlocks.JOSHUA_NATURAL_SET.getPottedSapling(),
                RuBlocks.KAPOK_NATURAL_SET.getPottedSapling(),
                RuBlocks.LARCH_NATURAL_SET.getPottedSapling(),
                RuBlocks.MAPLE_NATURAL_SET.getPottedSapling(),
                RuBlocks.MAUVE_NATURAL_SET.getPottedSapling(),
                RuBlocks.ORANGE_MAPLE_NATURAL_SET.getPottedSapling(),
                RuBlocks.PALM_NATURAL_SET.getPottedSapling(),
                RuBlocks.PINE_NATURAL_SET.getPottedSapling(),
                RuBlocks.BLUE_MAGNOLIA_NATURAL_SET.getPottedSapling(),
                RuBlocks.PINK_MAGNOLIA_NATURAL_SET.getPottedSapling(),
                RuBlocks.REDWOOD_NATURAL_SET.getPottedSapling(),
                RuBlocks.RED_MAPLE_NATURAL_SET.getPottedSapling(),
                RuBlocks.ENCHANTED_BIRCH_NATURAL_SET.getPottedSapling(),
                RuBlocks.SILVER_BIRCH_NATURAL_SET.getPottedSapling(),
                RuBlocks.SMALL_OAK_NATURAL_SET.getPottedSapling(),
                RuBlocks.SOCOTRA_NATURAL_SET.getPottedSapling(),
                RuBlocks.WHITE_MAGNOLIA_NATURAL_SET.getPottedSapling(),
                RuBlocks.WILLOW_NATURAL_SET.getPottedSapling(),
                //POTTED_MUSHROOMS
