...
public class RuEntityRenderer {
    public static void renderBoat(){
        ...
        Services.RENDER_HELPER.registerEntityRenderer(RegionsUnexploredEntities.BOAT, context -> new RuBoatRenderer(context, false));
        Services.RENDER_HELPER.registerEntityRenderer(RegionsUnexploredEntities.CHEST_BOAT, context -> new RuBoatRenderer(context, true));
    }
}
