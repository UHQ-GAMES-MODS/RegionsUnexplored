...
public class RuItems {
    ...
    public static final Supplier<Item> SALMONBERRY = registerItem("salmonberry", () -> new BlockItem(RuBlocks.SALMONBERRY_BUSH.get(), new Item.Properties().food(food(3, 0.3f, t -> t))));
