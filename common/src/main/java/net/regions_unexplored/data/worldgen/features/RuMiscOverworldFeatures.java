...
public class RuMiscOverworldFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, FALLEN_SILVER_BIRCH_TREE, FeatureRegistry.FALLEN_BLOB_TREE.get(), new FallenTreeConfiguration(BlockStateProvider.simple(RuBlocks.SILVER_BIRCH_WOOD_SET.getStrippedLog().defaultBlockState().setValue(AspenLogBlock.IS_BASE, true)), BlockStateProvider.simple(RuBlocks.SILVER_BIRCH_WOOD_SET.getStrippedLog().defaultBlockState()), BlockStateProvider.simple(RuBlocks.SILVER_BIRCH_NATURAL_SET.getLeaves().defaultBlockState()), 4, 3, false));
        //CAVE_FEATURES
