...
public class RuMiscOverworldFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreConfiguration.TargetBlockState> STONE_GRASS_TARGET_LIST = List.of(OreConfiguration.target(stoneOreTest, RuBlocks.STONE_GRASS_BLOCK.defaultBlockState()), OreConfiguration.target(deepslateOreTest, RuBlocks.DEEPSLATE_GRASS_BLOCK.defaultBlockState()));

        //---------------------FEATURES---------------------//
        register(context, DISK_CLAY, Feature.DISK, new DiskConfiguration(RuleBasedBlockStateProvider.simple(Blocks.CLAY), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, RuBlocks.PEAT_DIRT, RuBlocks.SILT_DIRT, RuBlocks.SILT_MUD, RuBlocks.PEAT_MUD, Blocks.CLAY)), UniformInt.of(2, 3), 1));
        register(context, DISK_GRAVEL, Feature.DISK, new DiskConfiguration(RuleBasedBlockStateProvider.simple(Blocks.GRAVEL), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, RuBlocks.PEAT_DIRT, RuBlocks.SILT_DIRT, RuBlocks.SILT_MUD, RuBlocks.PEAT_MUD, RuBlocks.SILT_GRASS_BLOCK, RuBlocks.PEAT_GRASS_BLOCK,  Blocks.GRASS_BLOCK)), UniformInt.of(2, 5), 2));
        register(context, DISK_SAND, Feature.DISK, new DiskConfiguration(new RuleBasedBlockStateProvider(BlockStateProvider.simple(Blocks.SAND), List.of(new RuleBasedBlockStateProvider.Rule(BlockPredicate.matchesBlocks(Direction.DOWN.getNormal(), Blocks.AIR), BlockStateProvider.simple(Blocks.SANDSTONE)))), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, RuBlocks.PEAT_DIRT, RuBlocks.SILT_DIRT, RuBlocks.SILT_MUD, RuBlocks.PEAT_MUD, RuBlocks.SILT_GRASS_BLOCK, RuBlocks.PEAT_GRASS_BLOCK,  Blocks.GRASS_BLOCK)), UniformInt.of(2, 6), 2));
        //ROCKS
        ...
        //FALLEN_TREES
        register(context, FALLEN_LARCH_TREE, FeatureRegistry.FALLEN_BLOB_TREE, new FallenTreeConfiguration(BlockStateProvider.simple(RuBlocks.LARCH_LOG.defaultBlockState()), BlockStateProvider.simple(RuBlocks.LARCH_LOG.defaultBlockState()), BlockStateProvider.simple(RuBlocks.GOLDEN_LARCH_LEAVES.defaultBlockState()), 5, 9, false));
        register(context, FALLEN_MAPLE_TREE, FeatureRegistry.FALLEN_BLOB_TREE, new FallenTreeConfiguration(BlockStateProvider.simple(RuBlocks.MAPLE_LOG.defaultBlockState()), BlockStateProvider.simple(RuBlocks.MAPLE_LOG.defaultBlockState()), BlockStateProvider.simple(RuBlocks.MAPLE_LEAVES.defaultBlockState()), 4, 4, false));
        register(context, FALLEN_OAK_TREE, FeatureRegistry.FALLEN_BLOB_TREE, new FallenTreeConfiguration(BlockStateProvider.simple(Blocks.OAK_LOG.defaultBlockState()), BlockStateProvider.simple(Blocks.OAK_LOG.defaultBlockState()), BlockStateProvider.simple(RuBlocks.DEAD_LEAVES.defaultBlockState()), 4, 4, false));
        register(context, FALLEN_OAK_TREE_WITH_BLOB, FeatureRegistry.FALLEN_BLOB_TREE, new FallenTreeConfiguration(BlockStateProvider.simple(Blocks.OAK_LOG.defaultBlockState()), BlockStateProvider.simple(Blocks.OAK_LOG.defaultBlockState()), BlockStateProvider.simple(RuBlocks.DEAD_LEAVES.defaultBlockState()), 4, 4, true));
        register(context, FALLEN_PINE_TREE, FeatureRegistry.FALLEN_BLOB_TREE, new FallenTreeConfiguration(BlockStateProvider.simple(RuBlocks.PINE_LOG.defaultBlockState()), BlockStateProvider.simple(RuBlocks.PINE_LOG.defaultBlockState()), BlockStateProvider.simple(RuBlocks.PINE_LEAVES.defaultBlockState()), 5, 6, false));
        register(context, FALLEN_SNOW_PINE_TREE, FeatureRegistry.FALLEN_SNOW_TREE, new FallenTreeConfiguration(BlockStateProvider.simple(RuBlocks.STRIPPED_PINE_LOG.defaultBlockState()), BlockStateProvider.simple(RuBlocks.STRIPPED_PINE_LOG.defaultBlockState()), BlockStateProvider.simple(RuBlocks.PINE_LEAVES.defaultBlockState()), 5, 6, false));
        register(context, FALLEN_SILVER_BIRCH_TREE, FeatureRegistry.FALLEN_BLOB_TREE, new FallenTreeConfiguration(BlockStateProvider.simple(RuBlocks.SILVER_BIRCH_LOG.defaultBlockState().setValue(AspenLogBlock.IS_BASE, true)), BlockStateProvider.simple(RuBlocks.SILVER_BIRCH_LOG.defaultBlockState()), BlockStateProvider.simple(RuBlocks.SILVER_BIRCH_LEAVES.defaultBlockState()), 4, 3, false));
        //CAVE_FEATURES
        register(context, POINTED_REDSTONE, Feature.SIMPLE_RANDOM_SELECTOR, new SimpleRandomFeatureConfiguration(HolderSet.direct(PlacementUtils.inlinePlaced(FeatureRegistry.POINTED_REDSTONE, new PointedRedstoneConfiguration(0.5F, 0.7F, 0.5F, 0.5F), EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.solid(), BlockPredicate.ONLY_IN_AIR_OR_WATER_PREDICATE, 12), RandomOffsetPlacement.vertical(ConstantInt.of(1))), PlacementUtils.inlinePlaced(FeatureRegistry.POINTED_REDSTONE, new PointedRedstoneConfiguration(0.5F, 0.7F, 0.5F, 0.5F), EnvironmentScanPlacement.scanningFor(Direction.UP, BlockPredicate.solid(), BlockPredicate.ONLY_IN_AIR_OR_WATER_PREDICATE, 12), RandomOffsetPlacement.vertical(ConstantInt.of(-1))))));
        register(context, LARGE_POINTED_REDSTONE, FeatureRegistry.LARGE_POINTED_REDSTONE, new LargePointedRedstoneConfiguration(30, UniformInt.of(1, 6), UniformFloat.of(0.4F, 2.0F), 0.33F, UniformFloat.of(0.3F, 0.9F), UniformFloat.of(0.4F, 1.0F), UniformFloat.of(0.0F, 0.3F), 4, 0.6F));
        register(context, POINTED_REDSTONE_CLUSTER, FeatureRegistry.POINTED_REDSTONE_CLUSTER, new PointedRedstoneClusterConfiguration(12, UniformInt.of(3, 6), UniformInt.of(2, 8), 1, 3, UniformInt.of(2, 4), UniformFloat.of(0.3F, 0.7F), ClampedNormalFloat.of(0.1F, 0.3F, 0.1F, 0.9F), 0.1F, 3, 8));
        register(context, ORE_REDSTONE_LARGE, Feature.ORE, new OreConfiguration(ORE_REDSTONE_TARGET_LIST, 20));

        register(context, PRISMARITE_CLUSTERS, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.LARGE_PRISMARITE_CLUSTER.defaultBlockState(), 1).add(RuBlocks.PRISMARITE_CLUSTER.defaultBlockState(), 5)), 32));
        register(context, HANGING_PRISMARITE_CLUSTER, FeatureRegistry.HANGING_PRISMARITE, FeatureConfiguration.NONE);
        ...
        register(context, LAVA_FALL, FeatureRegistry.LAVA_FALL, FeatureConfiguration.NONE);
        register(context, OVERWORLD_LAVA_DELTA, FeatureRegistry.OVERWORLD_LAVA_DELTA, new VegetationPatchConfiguration(BlockTags.LUSH_GROUND_REPLACEABLE, BlockStateProvider.simple(RuBlocks.VOLCANIC_ASH.defaultBlockState().setValue(AshBlock.HAS_GRAVITY, false)), PlacementUtils.inlinePlaced(holderGetter.getOrThrow(CaveFeatures.POINTED_DRIPSTONE)), CaveSurface.FLOOR, ConstantInt.of(3), 0.8F, 5, 0.1F, UniformInt.of(4, 7), 0.7F));
        register(context, ASH_VENT, FeatureRegistry.ASH_VENT, FeatureConfiguration.NONE);
        register(context, BASALT_BLOB, FeatureRegistry.BASALT_BLOB, new ColumnFeatureConfiguration(ConstantInt.of(1), UniformInt.of(1, 4)));
        //OTHER_FEATURES
