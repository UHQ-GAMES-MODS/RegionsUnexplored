...
public class RuAquaticFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, HYACINTH_FLOWERS.get(), Feature.MULTIFACE_GROWTH, new MultifaceGrowthConfiguration((MultifaceBlock) RuBlocks.HYACINTH_FLOWERS, 20, true, true, true, 1.0F, HolderSet.direct(Block::builtInRegistryHolder, Blocks.STONE, Blocks.PRISMARINE, Blocks.PRISMARINE_BRICKS)));
        ...
        register(context, BLUE_MAGNOLIA_FLOWERS_AQUATIC.get(), FeatureRegistry.AIR_MULTIFACE_GROWTH, new MultifaceGrowthConfiguration((MultifaceBlock) RuBlocks.BLUE_MAGNOLIA_FLOWERS, 20, true, true, true, 1.0F, HolderSet.direct(Block::builtInRegistryHolder, Blocks.STONE, RuBlocks.STONE_GRASS_BLOCK.get())));
        register(context, PINK_MAGNOLIA_FLOWERS_AQUATIC.get(), FeatureRegistry.AIR_MULTIFACE_GROWTH, new MultifaceGrowthConfiguration((MultifaceBlock) RuBlocks.PINK_MAGNOLIA_FLOWERS, 20, true, true, true, 1.0F, HolderSet.direct(Block::builtInRegistryHolder, Blocks.STONE, RuBlocks.STONE_GRASS_BLOCK.get())));
        register(context, WHITE_MAGNOLIA_FLOWERS_AQUATIC.get(), FeatureRegistry.AIR_MULTIFACE_GROWTH, new MultifaceGrowthConfiguration((MultifaceBlock) RuBlocks.WHITE_MAGNOLIA_FLOWERS, 20, true, true, true, 1.0F, HolderSet.direct(Block::builtInRegistryHolder, Blocks.STONE, RuBlocks.STONE_GRASS_BLOCK.get())));
