...
public class RuVegetationFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        duskMelon.add(RuBlocks.DUSKMELON.defaultBlockState().setValue(DuskmelonBlock.AGE, 1), 3).add(RuBlocks.DUSKMELON.defaultBlockState().setValue(DuskmelonBlock.AGE, 2), 2);
        for(int i = 1; i <= 4; ++i) {
            for(Direction direction : Direction.Plane.HORIZONTAL) {
                mapleLeafPileBuilder.add(RuBlocks.MAPLE_LEAF_PILE.defaultBlockState().setValue(GroundCoverBlock.AMOUNT, Integer.valueOf(i)).setValue(GroundCoverBlock.FACING, direction), 1);
                redMapleLeafPileBuilder.add(RuBlocks.RED_MAPLE_LEAF_PILE.defaultBlockState().setValue(GroundCoverBlock.AMOUNT, Integer.valueOf(i)).setValue(GroundCoverBlock.FACING, direction), 1);
                orangeMapleLeafPileBuilder.add(RuBlocks.ORANGE_MAPLE_LEAF_PILE.defaultBlockState().setValue(GroundCoverBlock.AMOUNT, Integer.valueOf(i)).setValue(GroundCoverBlock.FACING, direction), 1);
                silverBirchLeafPileBuilder.add(RuBlocks.SILVER_BIRCH_LEAF_PILE.defaultBlockState().setValue(GroundCoverBlock.AMOUNT, Integer.valueOf(i)).setValue(GroundCoverBlock.FACING, direction), 1);
                enchantedBirchLeafPileBuilder.add(RuBlocks.ENCHANTED_BIRCH_LEAF_PILE.defaultBlockState().setValue(GroundCoverBlock.AMOUNT, Integer.valueOf(i)).setValue(GroundCoverBlock.FACING, direction), 1);
                orangeConeflowerBuilder.add(RuBlocks.ORANGE_CONEFLOWER.defaultBlockState().setValue(GroundCoverBlock.AMOUNT, Integer.valueOf(i)).setValue(GroundCoverBlock.FACING, direction), 1);
                purpleConeflowerBuilder.add(RuBlocks.PURPLE_CONEFLOWER.defaultBlockState().setValue(GroundCoverBlock.AMOUNT, Integer.valueOf(i)).setValue(GroundCoverBlock.FACING, direction), 1);
                ...
                cloverBuilder.add(RuBlocks.CLOVER.defaultBlockState().setValue(GroundCoverBlock.AMOUNT, Integer.valueOf(i)).setValue(GroundCoverBlock.FACING, direction), 1);
            }
        }
        ...
        register(context, PATCH_TALL_FLOWERS, Feature.SIMPLE_RANDOM_SELECTOR, new SimpleRandomFeatureConfiguration(HolderSet.direct(PlacementUtils.inlinePlaced(Feature.RANDOM_PATCH, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.TASSEL)))), PlacementUtils.inlinePlaced(Feature.RANDOM_PATCH, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.DAY_LILY)))),  PlacementUtils.inlinePlaced(Feature.RANDOM_PATCH, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.MEADOW_SAGE)))), PlacementUtils.inlinePlaced(Feature.RANDOM_PATCH, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(Blocks.LILAC)))), PlacementUtils.inlinePlaced(Feature.RANDOM_PATCH, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(Blocks.ROSE_BUSH)))), PlacementUtils.inlinePlaced(Feature.RANDOM_PATCH, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(Blocks.PEONY)))), PlacementUtils.inlinePlaced(Feature.NO_BONEMEAL_FLOWER, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(Blocks.LILY_OF_THE_VALLEY)))))));
        //SIMPLE_BLOCK
        register(context, ASTER, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.ASTER)));
        register(context, BLACKWOOD_DECORATION, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.BLUE_BIOSHROOM.defaultBlockState(), 3).add(RuBlocks.PINK_BIOSHROOM.defaultBlockState(), 3).add(RuBlocks.TALL_BLUE_BIOSHROOM.defaultBlockState(), 1).add(RuBlocks.TALL_PINK_BIOSHROOM.defaultBlockState(), 1))));
        register(context, BLADED_GRASS_SINGLE, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.BLADED_GRASS.defaultBlockState())));
        register(context, CORPSE_FLOWER, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.CORPSE_FLOWER)));
        register(context, DAY_LILY, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.DAY_LILY)));
        register(context, DUSKTRAP, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.DUSKTRAP)));
        register(context, MEADOW_SAGE, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.MEADOW_SAGE)));
        register(context, BARREL_CACTUS, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.BARREL_CACTUS)));
        register(context, SANDY_GRASS, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.SANDY_GRASS)));
        register(context, TASSEL, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.TASSEL)));
        register(context, WHITE_SNOWBELLE, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.WHITE_SNOWBELLE)));
        //RANDOM_PATCH
        register(context, PATCH_ASHEN_GRASS, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.ASHEN_GRASS.defaultBlockState(), 4).add(RuBlocks.ASHEN_GRASS.defaultBlockState().setValue(AshenGrassBlock.SMOULDERING, true), 1)), 32));
        register(context, PATCH_BARLEY, Feature.RANDOM_PATCH, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.BARLEY))));
        ...
        register(context, PATCH_BLADED_GRASS, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.BLADED_GRASS.defaultBlockState(), 4).add(RuBlocks.BLADED_TALL_GRASS.defaultBlockState(), 1).add(Blocks.SHORT_GRASS.defaultBlockState(), 4)), 32));
        register(context, PATCH_CAVE_HYSSOP, Feature.RANDOM_PATCH, grassPatch(BlockStateProvider.simple(RuBlocks.CAVE_HYSSOP.defaultBlockState()), 32));
        ...
        register(context, PATCH_MEDIUM_GRASS, Feature.RANDOM_PATCH, grassPatch(BlockStateProvider.simple(RuBlocks.MEDIUM_GRASS.defaultBlockState()), 32));
        ...
        register(context, PATCH_PRISMOSS_SPROUT, Feature.RANDOM_PATCH, grassPatch(BlockStateProvider.simple(RuBlocks.PRISMOSS_SPROUT.defaultBlockState()), 32));
        register(context, PATCH_REDSTONE_BUD, Feature.RANDOM_PATCH, grassPatch(BlockStateProvider.simple(RuBlocks.REDSTONE_BUD.defaultBlockState()), 128));
        register(context, PATCH_REDSTONE_BULB, Feature.RANDOM_PATCH, grassPatch(BlockStateProvider.simple(RuBlocks.REDSTONE_BULB.defaultBlockState()), 64));
        ...
        register(context, PATCH_STEPPE_VEGETATION, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.STEPPE_GRASS.defaultBlockState(), 10).add(RuBlocks.STEPPE_SHRUB.defaultBlockState(), 10).add(RuBlocks.SMALL_DESERT_SHRUB.defaultBlockState(), 1).add(RuBlocks.STEPPE_TALL_GRASS.defaultBlockState(), 1).add(RuBlocks.DEAD_STEPPE_SHRUB.defaultBlockState(), 10)), 32));
        register(context, PATCH_SOCOTRA_VEGETATION, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.STEPPE_SHRUB.defaultBlockState(), 10).add(Blocks.SHORT_GRASS.defaultBlockState(), 10).add(RuBlocks.SMALL_DESERT_SHRUB.defaultBlockState(), 5).add(Blocks.TALL_GRASS.defaultBlockState(), 1)), 32));
        register(context, PATCH_OUTBACK_VEGETATION, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.STEPPE_GRASS.defaultBlockState(), 10).add(Blocks.SHORT_GRASS.defaultBlockState(), 10).add(RuBlocks.DEAD_STEPPE_SHRUB.defaultBlockState(), 5).add(RuBlocks.SMALL_DESERT_SHRUB.defaultBlockState(), 10)), 32));
        register(context, PATCH_JOSHUA_VEGETATION, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(Blocks.SHORT_GRASS.defaultBlockState(), 10).add(RuBlocks.SANDY_GRASS.defaultBlockState(), 8).add(RuBlocks.SMALL_DESERT_SHRUB.defaultBlockState(), 10)), 32));
        register(context, PATCH_SANDY_GRASS_VEGETATION, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.SANDY_GRASS.defaultBlockState(), 20).add(RuBlocks.SANDY_TALL_GRASS.defaultBlockState(), 1)), 32));
        ...
        register(context, PATCH_SNOW_GRASS, Feature.RANDOM_PATCH, grassPatch(BlockStateProvider.simple(RuBlocks.FROZEN_GRASS.defaultBlockState()), 32));
        register(context, PATCH_STONE_BUD, Feature.RANDOM_PATCH, grassPatch(BlockStateProvider.simple(RuBlocks.STONE_BUD.defaultBlockState()), 32));
        ...
        register(context, PATCH_WINDSWEPT_GRASS, Feature.RANDOM_PATCH, grassPatch(BlockStateProvider.simple(RuBlocks.WINDSWEPT_GRASS.defaultBlockState()), 32));
        //FLOWER
        register(context, PATCH_FROZEN_FLOWERS, Feature.FLOWER, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.BLEEDING_HEART.defaultBlockState(), 3).add(Blocks.LILY_OF_THE_VALLEY.defaultBlockState(), 2)))));
        register(context, PATCH_PINK_FLOWERS, Feature.FLOWER, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.FIREWEED.defaultBlockState(), 3).add(RuBlocks.TSUBAKI.defaultBlockState(), 2).add(RuBlocks.PINK_LUPINE.defaultBlockState(), 3).add(Blocks.PINK_TULIP.defaultBlockState(), 3)))));
        register(context, PATCH_ALPHA_DANDELION, Feature.FLOWER, new RandomPatchConfiguration(96, 6, 2, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.ALPHA_DANDELION.defaultBlockState())))));
        register(context, PATCH_ALPHA_ROSE, Feature.FLOWER, new RandomPatchConfiguration(96, 6, 2, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.ALPHA_ROSE.defaultBlockState())))));
        register(context, PATCH_AZURE_DAISY, Feature.FLOWER, new RandomPatchConfiguration(32, 4, 2, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(Blocks.AZURE_BLUET.defaultBlockState(), 1).add(Blocks.OXEYE_DAISY.defaultBlockState(), 1).add(RuBlocks.FELICIA_DAISY.defaultBlockState(), 2))))));
        register(context, PATCH_DAISY, Feature.FLOWER, new RandomPatchConfiguration(8, 1, 2, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.DAISY)))));
        register(context, PATCH_WARATAH, Feature.FLOWER, new RandomPatchConfiguration(8, 1, 2, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.WARATAH)))));
        register(context, PATCH_DAISIES, Feature.FLOWER, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.DAISY.defaultBlockState(), 1).add(RuBlocks.FELICIA_DAISY.defaultBlockState(), 1)), 32));
        register(context, PATCH_LUPINE_VEGETATION, Feature.FLOWER, new RandomPatchConfiguration(96, 6, 2, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.YELLOW_LUPINE.defaultBlockState(), 1).add(RuBlocks.RED_LUPINE.defaultBlockState(), 1).add(RuBlocks.BLUE_LUPINE.defaultBlockState(), 10).add(RuBlocks.PINK_LUPINE.defaultBlockState(), 10).add(RuBlocks.PURPLE_LUPINE.defaultBlockState(), 10))))));
        ...
        register(context, PATCH_MEADOW_VEGETATION, Feature.FLOWER, new RandomPatchConfiguration(96, 6, 2, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.HYSSOP.defaultBlockState(), 20).add(RuBlocks.FIREWEED.defaultBlockState(), 15).add(RuBlocks.DAISY.defaultBlockState(), 10).add(Blocks.SHORT_GRASS.defaultBlockState(), 40))))));
        ...
        register(context, PATCH_POPPIES, Feature.FLOWER, new RandomPatchConfiguration(96, 6, 2, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new NoiseProvider(2345L, new NormalNoise.NoiseParameters(0, 1.0D), 0.075F, List.of(RuBlocks.POPPY_BUSH.defaultBlockState(), RuBlocks.SALMON_POPPY_BUSH.defaultBlockState()))))));
        register(context, PATCH_PRAIRIE_FLOWERS, Feature.FLOWER, new RandomPatchConfiguration(32, 4, 2, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.POPPY_BUSH.defaultBlockState(), 3).add(RuBlocks.RED_LUPINE.defaultBlockState(), 2).add(RuBlocks.YELLOW_LUPINE.defaultBlockState(), 1))))));
        ...
        register(context, PATCH_SHRUBLAND_FLOWERS, Feature.FLOWER, new RandomPatchConfiguration(32, 4, 2, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.RED_LUPINE.defaultBlockState(), 1).add(RuBlocks.BLUE_LUPINE.defaultBlockState(), 1))))));
        register(context, PATCH_WILLOW_FLOWERS, Feature.FLOWER, new RandomPatchConfiguration(32, 4, 2, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.FELICIA_DAISY.defaultBlockState(), 2).add(RuBlocks.BLUE_LUPINE.defaultBlockState(), 2).add(Blocks.ALLIUM.defaultBlockState(), 1).add(Blocks.CORNFLOWER.defaultBlockState(), 2))))));
        register(context, PATCH_SMALL_FLOWERS, Feature.FLOWER, new RandomPatchConfiguration(96, 6, 2, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new NoiseProvider(2345L, new NormalNoise.NoiseParameters(0, 1.0D), 0.075F, List.of(RuBlocks.MALLOW.defaultBlockState(), RuBlocks.YELLOW_LUPINE.defaultBlockState(), Blocks.PINK_TULIP.defaultBlockState(), RuBlocks.POPPY_BUSH.defaultBlockState(), Blocks.OXEYE_DAISY.defaultBlockState(), RuBlocks.RED_LUPINE.defaultBlockState(), Blocks.CORNFLOWER.defaultBlockState(), RuBlocks.PINK_LUPINE.defaultBlockState(), RuBlocks.TSUBAKI.defaultBlockState(), Blocks.ORANGE_TULIP.defaultBlockState(), RuBlocks.WARATAH.defaultBlockState(), Blocks.WHITE_TULIP.defaultBlockState(), RuBlocks.HYSSOP.defaultBlockState(), Blocks.ALLIUM.defaultBlockState(), RuBlocks.BLUE_LUPINE.defaultBlockState(), RuBlocks.BLEEDING_HEART.defaultBlockState(), RuBlocks.SALMON_POPPY_BUSH.defaultBlockState(), RuBlocks.WHITE_TRILLIUM.defaultBlockState(), Blocks.BLUE_ORCHID.defaultBlockState(), RuBlocks.FIREWEED.defaultBlockState(), RuBlocks.DAISY.defaultBlockState(), RuBlocks.PURPLE_LUPINE.defaultBlockState(), Blocks.RED_TULIP.defaultBlockState(), RuBlocks.FELICIA_DAISY.defaultBlockState(), Blocks.POPPY.defaultBlockState(), Blocks.LILY_OF_THE_VALLEY.defaultBlockState()))))));
        ...
        register(context, PATCH_WHITE_TRILLIUM, Feature.FLOWER, new RandomPatchConfiguration(32, 4, 2, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.WHITE_TRILLIUM.defaultBlockState())))));
        register(context, PATCH_WILTING_TRILLIUM, Feature.FLOWER, new RandomPatchConfiguration(32, 4, 2, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.WILTING_TRILLIUM.defaultBlockState())))));
        register(context, PATCH_TSUBAKI, Feature.FLOWER, new RandomPatchConfiguration(32, 1, 2, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.TSUBAKI)))));
        register(context, PATCH_HIBISCUS, Feature.FLOWER, new RandomPatchConfiguration(14, 1, 2, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.HIBISCUS)))));
        register(context, PATCH_MALLOW, Feature.FLOWER, new RandomPatchConfiguration(16, 6, 2, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.MALLOW)))));
        register(context, PATCH_HYSSOP, Feature.FLOWER, new RandomPatchConfiguration(16, 1, 2, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.HYSSOP)))));
        //TREE
        ...
        //MULTIFACE
        register(context, PINK_MAGNOLIA_FLOWERS, FeatureRegistry.AIR_MULTIFACE_GROWTH, new MultifaceGrowthConfiguration((MultifaceBlock) RuBlocks.PINK_MAGNOLIA_FLOWERS, 20, true, false, false, 1.0F, HolderSet.direct(Block::builtInRegistryHolder, Blocks.SHORT_GRASS, RuBlocks.PEAT_GRASS_BLOCK, RuBlocks.SILT_GRASS_BLOCK)));
        register(context, WHITE_MAGNOLIA_FLOWERS, FeatureRegistry.AIR_MULTIFACE_GROWTH, new MultifaceGrowthConfiguration((MultifaceBlock) RuBlocks.WHITE_MAGNOLIA_FLOWERS, 20, true, false, false, 1.0F, HolderSet.direct(Block::builtInRegistryHolder, Blocks.SHORT_GRASS, RuBlocks.PEAT_GRASS_BLOCK, RuBlocks.SILT_GRASS_BLOCK)));
        //FOOD_PLANTS
        register(context, PATCH_SALMONBERRY_BUSH, Feature.RANDOM_PATCH, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.SALMONBERRY_BUSH.defaultBlockState().setValue(SalmonBerryBushBlock.AGE, Integer.valueOf(3)))), List.of(Blocks.SHORT_GRASS, Blocks.PODZOL, RuBlocks.PEAT_GRASS_BLOCK, RuBlocks.SILT_GRASS_BLOCK, RuBlocks.PEAT_PODZOL, RuBlocks.SILT_PODZOL)));
        register(context, DUSKMELON, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(new WeightedStateProvider(duskMelon)));
        //BIOSHROOM
        register(context, PATCH_BLUE_BIOSHROOM, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.TALL_BLUE_BIOSHROOM.defaultBlockState(), 1).add(RuBlocks.BLUE_BIOSHROOM.defaultBlockState(), 10)), 16));
        register(context, PATCH_GREEN_BIOSHROOM, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.TALL_GREEN_BIOSHROOM.defaultBlockState(), 1).add(RuBlocks.GREEN_BIOSHROOM.defaultBlockState(), 10)), 16));
        register(context, PATCH_PINK_BIOSHROOM, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.TALL_PINK_BIOSHROOM.defaultBlockState(), 1).add(RuBlocks.PINK_BIOSHROOM.defaultBlockState(), 8)), 16));
        register(context, PATCH_YELLOW_BIOSHROOM, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.TALL_YELLOW_BIOSHROOM.defaultBlockState(), 1).add(RuBlocks.YELLOW_BIOSHROOM.defaultBlockState(), 6)), 6));
        //OTHER
        register(context, BAMBOO, Feature.BAMBOO, new ProbabilityFeatureConfiguration(0.25F));
        register(context, FLOWERING_LILY, Feature.RANDOM_PATCH, new RandomPatchConfiguration(10, 7, 3, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.FLOWERING_LILY_PAD)))));
        register(context, GIANT_LILY, FeatureRegistry.GIANT_LILY, FeatureConfiguration.NONE);
        register(context, ELEPHANT_EAR, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.ELEPHANT_EAR)));
        register(context, DROPLEAF, FeatureRegistry.DROPLEAF, FeatureConfiguration.NONE);
        register(context, DUCKWEED, Feature.RANDOM_PATCH, new RandomPatchConfiguration(10, 7, 3, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(RuBlocks.DUCKWEED)))));

        //SHRUBS
        register(context, ASHEN_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.ASHEN_SHRUB.defaultBlockState())));
        register(context, ACACIA_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.ACACIA_SHRUB.defaultBlockState())));
        register(context, BAOBAB_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.BAOBAB_SHRUB.defaultBlockState())));
        register(context, BIRCH_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.BIRCH_SHRUB.defaultBlockState())));
        register(context, BLACKWOOD_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.BLACKWOOD_SHRUB.defaultBlockState())));
        register(context, CHERRY_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.CHERRY_SHRUB.defaultBlockState())));
        register(context, MAGNOLIA_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.MAGNOLIA_SHRUB.defaultBlockState())));
        register(context, PINK_MAGNOLIA_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.PINK_MAGNOLIA_SHRUB.defaultBlockState())));
        register(context, WHITE_MAGNOLIA_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.WHITE_MAGNOLIA_SHRUB.defaultBlockState())));
        register(context, CYPRESS_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.CYPRESS_SHRUB.defaultBlockState())));
        register(context, DARK_OAK_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.DARK_OAK_SHRUB.defaultBlockState())));
        register(context, DEAD_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.DEAD_SHRUB.defaultBlockState())));
        register(context, DEAD_PINE_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.DEAD_PINE_SHRUB.defaultBlockState())));
        register(context, EUCALYPTUS_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.EUCALYPTUS_SHRUB.defaultBlockState())));
        register(context, FLOWERING_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.FLOWERING_SHRUB.defaultBlockState())));
        register(context, JOSHUA_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.JOSHUA_SHRUB.defaultBlockState())));
        register(context, JUNGLE_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.JUNGLE_SHRUB.defaultBlockState())));
        register(context, LARCH_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.LARCH_SHRUB.defaultBlockState())));
        register(context, GOLDEN_LARCH_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.GOLDEN_LARCH_SHRUB.defaultBlockState())));
        register(context, MANGROVE_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.MANGROVE_SHRUB.defaultBlockState())));
        register(context, MAPLE_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.MAPLE_SHRUB.defaultBlockState())));
        register(context, RED_MAPLE_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.RED_MAPLE_SHRUB.defaultBlockState())));
        register(context, ORANGE_MAPLE_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.ORANGE_MAPLE_SHRUB.defaultBlockState())));
        register(context, MAUVE_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.MAUVE_SHRUB.defaultBlockState())));
        register(context, OAK_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.OAK_SHRUB.defaultBlockState())));
        register(context, PALM_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.PALM_SHRUB.defaultBlockState())));
        register(context, PINE_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.PINE_SHRUB.defaultBlockState())));
        register(context, REDWOOD_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.REDWOOD_SHRUB.defaultBlockState())));
        register(context, SILVER_BIRCH_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.SILVER_BIRCH_SHRUB.defaultBlockState())));
        register(context, SOCOTRA_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.SOCOTRA_SHRUB.defaultBlockState())));
        register(context, SPRUCE_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.SPRUCE_SHRUB.defaultBlockState())));
        register(context, WILLOW_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.WILLOW_SHRUB.defaultBlockState())));
        //mixes
        register(context, BAOBAB_ACACIA_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.BAOBAB_SHRUB.defaultBlockState(), 2).add(RuBlocks.ACACIA_SHRUB.defaultBlockState(), 1))));
        register(context, AUTUMNAL_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.MAPLE_SHRUB.defaultBlockState(), 2).add(RuBlocks.SILVER_BIRCH_SHRUB.defaultBlockState(), 4).add(RuBlocks.RED_MAPLE_SHRUB.defaultBlockState(), 4).add(RuBlocks.ORANGE_MAPLE_SHRUB.defaultBlockState(), 4))));
        register(context, BIRCH_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.SILVER_BIRCH_SHRUB.defaultBlockState(), 3).add(RuBlocks.BIRCH_SHRUB.defaultBlockState(), 1))));
        register(context, BLACKWOOD_DARK_OAK_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.BLACKWOOD_SHRUB.defaultBlockState(), 3).add(RuBlocks.DARK_OAK_SHRUB.defaultBlockState(), 1))));
        register(context, MAGNOLIA_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.MAGNOLIA_SHRUB.defaultBlockState(), 1).add(RuBlocks.PINK_MAGNOLIA_SHRUB.defaultBlockState(), 1).add(RuBlocks.WHITE_MAGNOLIA_SHRUB.defaultBlockState(), 1))));
        register(context, DEAD_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.DEAD_SHRUB.defaultBlockState(), 2).add(RuBlocks.DEAD_PINE_SHRUB.defaultBlockState(), 1))));
        register(context, LARCH_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.LARCH_SHRUB.defaultBlockState(), 3).add(RuBlocks.GOLDEN_LARCH_SHRUB.defaultBlockState(), 1))));
        register(context, GOLDEN_LARCH_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.LARCH_SHRUB.defaultBlockState(), 1).add(RuBlocks.GOLDEN_LARCH_SHRUB.defaultBlockState(), 3))));
        register(context, MAPLE_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.MAPLE_SHRUB.defaultBlockState(), 4).add(RuBlocks.RED_MAPLE_SHRUB.defaultBlockState(), 1))));
        register(context, MAUVE_ENCHANTED_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.MAUVE_SHRUB.defaultBlockState(), 3).add(RuBlocks.ENCHANTED_BIRCH_SHRUB.defaultBlockState(), 1))));
        register(context, PINE_SPRUCE_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.PINE_SHRUB.defaultBlockState(), 1).add(RuBlocks.SPRUCE_SHRUB.defaultBlockState(), 1))));
        register(context, PINE_DEAD_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.PINE_SHRUB.defaultBlockState(), 2).add(RuBlocks.DEAD_PINE_SHRUB.defaultBlockState(), 1))));
        register(context, PALM_JUNGLE_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.PALM_SHRUB.defaultBlockState(), 5).add(RuBlocks.JUNGLE_SHRUB.defaultBlockState(), 1))));
        register(context, WILLOW_CYPRESS_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.WILLOW_SHRUB.defaultBlockState(), 2).add(RuBlocks.CYPRESS_SHRUB.defaultBlockState(), 1))));
        register(context, WILLOW_MAGNOLIA_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.WILLOW_SHRUB.defaultBlockState(), 2).add(RuBlocks.BLUE_MAGNOLIA_SHRUB.defaultBlockState(), 1))));
