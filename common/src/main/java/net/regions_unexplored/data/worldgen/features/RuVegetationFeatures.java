...
public class RuVegetationFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        //MULTIFACE
        register(context, PINK_MAGNOLIA_FLOWERS, FeatureRegistry.AIR_MULTIFACE_GROWTH, new MultifaceGrowthConfiguration((MultifaceBlock)RuBlocks.PINK_MAGNOLIA_FLOWERS.get(), 20, true, false, false, 1.0F, HolderSet.direct(Block::builtInRegistryHolder, Blocks.GRASS_BLOCK, RuBlocks.PEAT_GRASS_BLOCK.get(), RuBlocks.SILT_GRASS_BLOCK.get())));
        register(context, WHITE_MAGNOLIA_FLOWERS, FeatureRegistry.AIR_MULTIFACE_GROWTH, new MultifaceGrowthConfiguration((MultifaceBlock)RuBlocks.WHITE_MAGNOLIA_FLOWERS.get(), 20, true, false, false, 1.0F, HolderSet.direct(Block::builtInRegistryHolder, Blocks.GRASS_BLOCK, RuBlocks.PEAT_GRASS_BLOCK.get(), RuBlocks.SILT_GRASS_BLOCK.get())));
        //FOOD_PLANTS
        ...
        //SHRUBS
        register(context, ASHEN_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.ASHEN_SHRUB.get().defaultBlockState())));
        register(context, ACACIA_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.ACACIA_SHRUB.get().defaultBlockState())));
        register(context, BAOBAB_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.BAOBAB_SHRUB.get().defaultBlockState())));
        register(context, BIRCH_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.BIRCH_SHRUB.get().defaultBlockState())));
        register(context, BLACKWOOD_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.BLACKWOOD_SHRUB.get().defaultBlockState())));
        register(context, CHERRY_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.CHERRY_SHRUB.get().defaultBlockState())));
        register(context, MAGNOLIA_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.MAGNOLIA_SHRUB.get().defaultBlockState())));
        register(context, PINK_MAGNOLIA_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.PINK_MAGNOLIA_SHRUB.get().defaultBlockState())));
        register(context, WHITE_MAGNOLIA_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.WHITE_MAGNOLIA_SHRUB.get().defaultBlockState())));
        register(context, CYPRESS_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.CYPRESS_SHRUB.get().defaultBlockState())));
        register(context, DARK_OAK_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.DARK_OAK_SHRUB.get().defaultBlockState())));
        register(context, DEAD_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.DEAD_SHRUB.get().defaultBlockState())));
        register(context, DEAD_PINE_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.DEAD_PINE_SHRUB.get().defaultBlockState())));
        register(context, EUCALYPTUS_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.EUCALYPTUS_SHRUB.get().defaultBlockState())));
        register(context, FLOWERING_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.FLOWERING_SHRUB.get().defaultBlockState())));
        register(context, JOSHUA_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.JOSHUA_SHRUB.get().defaultBlockState())));
        register(context, JUNGLE_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.JUNGLE_SHRUB.get().defaultBlockState())));
        register(context, LARCH_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.LARCH_SHRUB.get().defaultBlockState())));
        register(context, GOLDEN_LARCH_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.GOLDEN_LARCH_SHRUB.get().defaultBlockState())));
        register(context, MANGROVE_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.MANGROVE_SHRUB.get().defaultBlockState())));
        register(context, MAPLE_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.MAPLE_SHRUB.get().defaultBlockState())));
        register(context, RED_MAPLE_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.RED_MAPLE_SHRUB.get().defaultBlockState())));
        register(context, ORANGE_MAPLE_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.ORANGE_MAPLE_SHRUB.get().defaultBlockState())));
        register(context, MAUVE_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.MAUVE_SHRUB.get().defaultBlockState())));
        register(context, OAK_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.OAK_SHRUB.get().defaultBlockState())));
        register(context, PALM_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.PALM_SHRUB.get().defaultBlockState())));
        register(context, PINE_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.PINE_SHRUB.get().defaultBlockState())));
        register(context, REDWOOD_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.REDWOOD_SHRUB.get().defaultBlockState())));
        register(context, SILVER_BIRCH_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.SILVER_BIRCH_SHRUB.get().defaultBlockState())));
        register(context, SOCOTRA_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.SOCOTRA_SHRUB.get().defaultBlockState())));
        register(context, SPRUCE_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.SPRUCE_SHRUB.get().defaultBlockState())));
        register(context, WILLOW_SHRUB, FeatureRegistry.SHRUB, new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.WILLOW_SHRUB.get().defaultBlockState())));
        //mixes
        register(context, BAOBAB_ACACIA_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.BAOBAB_SHRUB.get().defaultBlockState(), 2).add(RuBlocks.ACACIA_SHRUB.get().defaultBlockState(), 1))));
        ...
        register(context, BIRCH_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.SILVER_BIRCH_SHRUB.get().defaultBlockState(), 3).add(RuBlocks.BIRCH_SHRUB.get().defaultBlockState(), 1))));
        register(context, BLACKWOOD_DARK_OAK_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.BLACKWOOD_SHRUB.get().defaultBlockState(), 3).add(RuBlocks.DARK_OAK_SHRUB.get().defaultBlockState(), 1))));
        ...
        register(context, DEAD_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.DEAD_SHRUB.get().defaultBlockState(), 2).add(RuBlocks.DEAD_PINE_SHRUB.get().defaultBlockState(), 1))));
        register(context, LARCH_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.LARCH_SHRUB.get().defaultBlockState(), 3).add(RuBlocks.GOLDEN_LARCH_SHRUB.get().defaultBlockState(), 1))));
        register(context, GOLDEN_LARCH_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.LARCH_SHRUB.get().defaultBlockState(), 1).add(RuBlocks.GOLDEN_LARCH_SHRUB.get().defaultBlockState(), 3))));
        register(context, MAPLE_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.MAPLE_SHRUB.get().defaultBlockState(), 4).add(RuBlocks.RED_MAPLE_SHRUB.get().defaultBlockState(), 1))));
        register(context, MAUVE_ENCHANTED_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.MAUVE_SHRUB.get().defaultBlockState(), 3).add(RuBlocks.ENCHANTED_BIRCH_SHRUB.get().defaultBlockState(), 1))));
        register(context, PINE_SPRUCE_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.PINE_SHRUB.get().defaultBlockState(), 1).add(RuBlocks.SPRUCE_SHRUB.get().defaultBlockState(), 1))));
        register(context, PINE_DEAD_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.PINE_SHRUB.get().defaultBlockState(), 2).add(RuBlocks.DEAD_PINE_SHRUB.get().defaultBlockState(), 1))));
        register(context, PALM_JUNGLE_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.PALM_SHRUB.get().defaultBlockState(), 5).add(RuBlocks.JUNGLE_SHRUB.get().defaultBlockState(), 1))));
        register(context, WILLOW_CYPRESS_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.WILLOW_SHRUB.get().defaultBlockState(), 2).add(RuBlocks.CYPRESS_SHRUB.get().defaultBlockState(), 1))));
        register(context, WILLOW_MAGNOLIA_SHRUB_MIX, FeatureRegistry.SHRUB, new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.WILLOW_SHRUB.get().defaultBlockState(), 2).add(RuBlocks.BLUE_MAGNOLIA_SHRUB.get().defaultBlockState(), 1))));
