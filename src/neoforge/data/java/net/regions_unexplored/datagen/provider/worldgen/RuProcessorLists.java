package net.regions_unexplored.datagen.provider.worldgen;
...
public class RuProcessorLists {
    public static final ResourceKey<StructureProcessorList> SHIPWRECK_DARK_OAK_AND_BAOBAB = shipwreck("dark_oak", "baobab");
    public static final ResourceKey<StructureProcessorList> SHIPWRECK_DARK_OAK_AND_DEAD = shipwreck("dark_oak", "dead");
    public static final ResourceKey<StructureProcessorList> SHIPWRECK_DARK_OAK_AND_EUCALYPTUS = shipwreck("dark_oak", "eucalyptus");
    public static final ResourceKey<StructureProcessorList> SHIPWRECK_DARK_OAK_AND_JOSHUA = shipwreck("dark_oak", "joshua");
    public static final ResourceKey<StructureProcessorList> SHIPWRECK_DARK_OAK_AND_KAPOK = shipwreck("dark_oak", "kapok");
    public static final ResourceKey<StructureProcessorList> SHIPWRECK_DARK_OAK_AND_LARCH = shipwreck("dark_oak", "larch");
    public static final ResourceKey<StructureProcessorList> SHIPWRECK_DEAD_AND_DARK_OAK = shipwreck("dead", "dark_oak");
    public static final ResourceKey<StructureProcessorList> SHIPWRECK_DEAD_AND_LARCH = shipwreck("dead", "larch");
