...
public class PlacerTypeRegistry {
    ...
    private static void registerFoliagePlacers(RegisterEvent event){
        event.register(Registries.FOLIAGE_PLACER_TYPE, RegionsUnexplored.id("willow_foliage_placer"), () -> WillowFoliagePlacer.WILLOW_FOLIAGE_PLACER);
        event.register(Registries.FOLIAGE_PLACER_TYPE, RegionsUnexplored.id("sakura_foliage_placer"), () -> SakuraFoliagePlacer.SAKURA_FOLIAGE_PLACER);
    }
