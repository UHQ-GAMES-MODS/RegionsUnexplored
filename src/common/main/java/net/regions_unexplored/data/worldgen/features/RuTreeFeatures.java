...
public class RuTreeFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?,?>> TREE_GROUP_OLD_GROWTH_BAYOU = treeGroup("old_growth_bayou");
    public static final ResourceKey<ConfiguredFeature<?,?>> TREE_GROUP_AUTUMNAL_MAPLE_FOREST = treeGroup("autumnal_maple");
    public static final ResourceKey<ConfiguredFeature<?,?>> TREE_GROUP_PUMPKIN_FIELDS = treeGroup("pumpkin_fields");

    private static ResourceKey<ConfiguredFeature<?,?>> treeGroup(String name) {
        return key("group/" + name);
    }

    private static ResourceKey<ConfiguredFeature<?,?>> key(String name) {
        return createKey("tree/" + name);
    }
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, ACACIA_TREE_SHRUB, RUFeatureTypes.TREE_SHRUB.get(), new RuTreeConfiguration(BlockStateProvider.simple(Blocks.ACACIA_LOG.defaultBlockState()), BlockStateProvider.simple(Blocks.ACACIA_LEAVES.defaultBlockState()), BlockStateProvider.simple(RUBlocks.ACACIA_NATURAL_SET.getBranch().defaultBlockState()), 1, 3));
        ...
        register(context, BIG_BLACKWOOD_TREE, RUFeatureTypes.BLACKWOOD_TREE.get(), new RuTreeConfiguration(BlockStateProvider.simple(RUBlocks.BLACKWOOD_WOOD_SET.getLog().defaultBlockState()), BlockStateProvider.simple(RUBlocks.BLACKWOOD_NATURAL_SET.getLeaves().defaultBlockState()), BlockStateProvider.simple(RUBlocks.BLACKWOOD_NATURAL_SET.getBranch().defaultBlockState()), 19, 5));

        register(context, BIRCH_TREE_ASPEN, RUFeatureTypes.ASPEN_TREE.get(), new RuTreeConfiguration(BlockStateProvider.simple(Blocks.BIRCH_LOG.defaultBlockState()), BlockStateProvider.simple(Blocks.BIRCH_LEAVES.defaultBlockState()), BlockStateProvider.simple(RUBlocks.BIRCH_NATURAL_SET.getBranch().defaultBlockState()), 4, 3));

        register(context, COBALT_TREE, RUFeatureTypes.COBALT_TREE.get(), FeatureConfiguration.NONE);
        ...
        var cypress = register(context, CYPRESS_TREE, RUFeatureTypes.CYPRESS_TREE.get(), new RuTreeConfiguration(BlockStateProvider.simple(RUBlocks.CYPRESS_WOOD_SET.getLog().defaultBlockState()), BlockStateProvider.simple(RUBlocks.CYPRESS_NATURAL_SET.getLeaves().defaultBlockState()), BlockStateProvider.simple(RUBlocks.CYPRESS_NATURAL_SET.getBranch().defaultBlockState()), 17, 4));
        var giantCypress = register(context, GIANT_CYPRESS_TREE, RUFeatureTypes.GIANT_CYPRESS_TREE.get(), new RuTreeConfiguration(BlockStateProvider.simple(RUBlocks.CYPRESS_WOOD_SET.getLog().defaultBlockState()), BlockStateProvider.simple(RUBlocks.CYPRESS_NATURAL_SET.getLeaves().defaultBlockState()), BlockStateProvider.simple(RUBlocks.CYPRESS_NATURAL_SET.getBranch().defaultBlockState()), 25, 5));
        register(context, TREE_GROUP_OLD_GROWTH_BAYOU, Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(
        ...
        register(context, DEAD_STRIPPED_PINE_TREE_MOUNTAIN, RUFeatureTypes.STRIPPED_PINE_TREE.get(), new RuTreeConfiguration(BlockStateProvider.simple(RUBlocks.PINE_WOOD_SET.getLog().defaultBlockState()), BlockStateProvider.simple(RUBlocks.DEAD_PINE_NATURAL_SET.getLeaves().defaultBlockState()), BlockStateProvider.simple(RUBlocks.PINE_NATURAL_SET.getBranch().defaultBlockState()), 15, 7));

        register(context, SMALL_EUCALYPTUS_TREE, RUFeatureTypes.SMALL_EUCALYPTUS_TREE.get(), new RuTreeConfiguration(BlockStateProvider.simple(RUBlocks.EUCALYPTUS_WOOD_SET.getLog().defaultBlockState()), BlockStateProvider.simple(RUBlocks.EUCALYPTUS_NATURAL_SET.getLeaves().defaultBlockState()), BlockStateProvider.simple(RUBlocks.EUCALYPTUS_NATURAL_SET.getBranch().defaultBlockState()), 13, 8));
        register(context, EUCALYPTUS_TREE, RUFeatureTypes.EUCALYPTUS_TREE.get(), new RuTreeConfiguration(BlockStateProvider.simple(RUBlocks.EUCALYPTUS_WOOD_SET.getLog().defaultBlockState()), BlockStateProvider.simple(RUBlocks.EUCALYPTUS_NATURAL_SET.getLeaves().defaultBlockState()), BlockStateProvider.simple(RUBlocks.EUCALYPTUS_NATURAL_SET.getBranch().defaultBlockState()), 14, 8));

        register(context, MEDIUM_JOSHUA_TREE, RUFeatureTypes.MEDIUM_JOSHUA_TREE.get(), FeatureConfiguration.NONE);
        register(context, LARGE_JOSHUA_TREE, RUFeatureTypes.LARGE_JOSHUA_TREE.get(), FeatureConfiguration.NONE);
        register(context, JOSHUA_TREE_SHRUB, RUFeatureTypes.SMALL_JOSHUA_TREE.get(), new RuTreeConfiguration(BlockStateProvider.simple(RUBlocks.JOSHUA_WOOD_SET.getLog().defaultBlockState()), BlockStateProvider.simple(RUBlocks.JOSHUA_NATURAL_SET.getLeaves().defaultBlockState()), BlockStateProvider.simple(RUBlocks.JOSHUA_NATURAL_SET.getBranch().defaultBlockState()), 1, 1));
        ...
        .build()));
        register(context, TREE_GROUP_PUMPKIN_FIELDS, WeightedSelectorFeature.FEATURE, new WeightedSelectorConfig(WeightedList.<Holder<PlacedFeature>>builder()
        ...
        register(context, OAK_TREE_WITH_FLOWERS, RUFeatureTypes.ASPEN_TREE.get(), new RuTreeConfiguration(BlockStateProvider.simple(Blocks.OAK_LOG.defaultBlockState()), new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(Blocks.OAK_LEAVES.defaultBlockState(), 3).add(RUBlocks.FLOWERING_NATURAL_SET.getLeaves().defaultBlockState(), 1)), BlockStateProvider.simple(RUBlocks.OAK_NATURAL_SET.getBranch().defaultBlockState()), 5, 5));

        register(context, OAK_TREE_WITH_BRANCH, RUFeatureTypes.MAPLE_TREE.get(), new RuTreeConfiguration(BlockStateProvider.simple(Blocks.OAK_LOG.defaultBlockState()), BlockStateProvider.simple(Blocks.OAK_LEAVES.defaultBlockState()), BlockStateProvider.simple(RUBlocks.OAK_NATURAL_SET.getBranch().defaultBlockState()), 6, 4));
        ...
        register(context, OAK_TREE_SHRUB, RUFeatureTypes.TREE_SHRUB.get(), new RuTreeConfiguration(BlockStateProvider.simple(Blocks.OAK_LOG.defaultBlockState()), BlockStateProvider.simple(Blocks.OAK_LEAVES.defaultBlockState()), BlockStateProvider.simple(RUBlocks.OAK_NATURAL_SET.getBranch().defaultBlockState()), 1, 0));
        ...
        register(context, ENCHANTED_BIRCH_TREE_TALL, RUFeatureTypes.ASPEN_TREE.get(), new RuTreeConfiguration(BlockStateProvider.simple(RUBlocks.SILVER_BIRCH_WOOD_SET.getLog().defaultBlockState()), BlockStateProvider.simple(RUBlocks.ENCHANTED_BIRCH_NATURAL_SET.getLeaves().defaultBlockState()), BlockStateProvider.simple(RUBlocks.SILVER_BIRCH_NATURAL_SET.getBranch().defaultBlockState()), List.of(PlaceOnGroundDecorator.leafLitter(RUBlocks.ENCHANTED_BIRCH_LEAF_PILE.get(), 96)), 5, 5));
