...
public class RuTreePlacements {
    ...
    public static final ResourceKey<PlacedFeature> TREE_GROUP_OLD_GROWTH_BAYOU = treeGroup("old_growth_bayou");
    ...
    public static final ResourceKey<PlacedFeature> TREE_GROUP_AUTUMNAL_MAPLE_FOREST = treeGroup("autumnal_maple_forest");
    public static final ResourceKey<PlacedFeature> TREE_GROUP_PUMPKIN_FIELDS = treeGroup("pumpkin_fields");
    ...
    private static ResourceKey<PlacedFeature> treeGroup(String name) {
        return key("group/" + name);
    }

    private static ResourceKey<PlacedFeature> key(String name) {
        return PlacedFeatureRegistry.createKey("tree/" + name);
    }
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        final Holder<ConfiguredFeature<?, ?>> ALPHA_TREE = getter.getOrThrow(RuTreeFeatures.ALPHA_OAK_TREE);

        final Holder<ConfiguredFeature<?, ?>> ACACIA_TREE = getter.getOrThrow(RuTreeFeatures.ACACIA_TREE);
        final Holder<ConfiguredFeature<?, ?>> ACACIA_TREE_SHRUB = getter.getOrThrow(RuTreeFeatures.ACACIA_TREE_SHRUB);

        final Holder<ConfiguredFeature<?, ?>> APPLE_OAK_TREE = getter.getOrThrow(RuTreeFeatures.APPLE_OAK_TREE);
        final Holder<ConfiguredFeature<?, ?>> BIG_APPLE_OAK_TREE = getter.getOrThrow(RuTreeFeatures.BIG_APPLE_OAK_TREE);

        final Holder<ConfiguredFeature<?, ?>> ASHEN_TREE = getter.getOrThrow(RuTreeFeatures.ASHEN_TREE);
        final Holder<ConfiguredFeature<?, ?>> ASHEN_PINE_TREE = getter.getOrThrow(RuTreeFeatures.ASHEN_PINE_TREE);

        final Holder<ConfiguredFeature<?, ?>> TALL_BLACKWOOD_TREE = getter.getOrThrow(RuTreeFeatures.BIG_BLACKWOOD_TREE);
        final Holder<ConfiguredFeature<?, ?>> BLACKWOOD_TREE = getter.getOrThrow(RuTreeFeatures.BLACKWOOD_TREE);

        final Holder<ConfiguredFeature<?, ?>> BAMBOO_TREE = getter.getOrThrow(RuTreeFeatures.BAMBOO_TREE);

        final Holder<ConfiguredFeature<?, ?>> MEGA_BAOBAB_TREE = getter.getOrThrow(RuTreeFeatures.MEGA_BAOBAB_TREE);
        final Holder<ConfiguredFeature<?, ?>> ULTRA_BAOBAB_TREE = getter.getOrThrow(RuTreeFeatures.ULTRA_BAOBAB_TREE);

        final Holder<ConfiguredFeature<?, ?>> BRIM_WILLOW_TREE = getter.getOrThrow(RuTreeFeatures.BRIM_WILLOW_TREE);
        final Holder<ConfiguredFeature<?, ?>> TALL_BRIM_WILLOW_TREE = getter.getOrThrow(RuTreeFeatures.TALL_BRIM_WILLOW_TREE);

        final Holder<ConfiguredFeature<?, ?>> BIRCH_TREE_ASPEN = getter.getOrThrow(RuTreeFeatures.BIRCH_TREE_ASPEN);

        final Holder<ConfiguredFeature<?, ?>> CYPRESS_TREE = getter.getOrThrow(RuTreeFeatures.CYPRESS_TREE);
        final Holder<ConfiguredFeature<?, ?>> GIANT_CYPRESS_TREE = getter.getOrThrow(RuTreeFeatures.GIANT_CYPRESS_TREE);

        final Holder<ConfiguredFeature<?, ?>> COBALT_TREE = getter.getOrThrow(RuTreeFeatures.COBALT_TREE);

        final Holder<ConfiguredFeature<?, ?>> CHERRY_TREE = getter.getOrThrow(RuTreeFeatures.CHERRY_TREE);

        final Holder<ConfiguredFeature<?, ?>> DEAD_BOG_TREE = getter.getOrThrow(RuTreeFeatures.DEAD_BOG_TREE);

        final Holder<ConfiguredFeature<?, ?>> DEAD_SCOTTS_PINE_TREE = getter.getOrThrow(RuTreeFeatures.DEAD_STRIPPED_PINE_TREE);
        final Holder<ConfiguredFeature<?, ?>> DEAD_SCOTTS_PINE_TREE_MOUNTAIN = getter.getOrThrow(RuTreeFeatures.DEAD_STRIPPED_PINE_TREE_MOUNTAIN);

        final Holder<ConfiguredFeature<?, ?>> TALL_DARK_OAK = getter.getOrThrow(RuTreeFeatures.TALL_DARK_OAK);

        final Holder<ConfiguredFeature<?, ?>> SMALL_EUCALYPTUS_TREE = getter.getOrThrow(RuTreeFeatures.SMALL_EUCALYPTUS_TREE);
        final Holder<ConfiguredFeature<?, ?>> EUCALYPTUS_TREE = getter.getOrThrow(RuTreeFeatures.EUCALYPTUS_TREE);

        final Holder<ConfiguredFeature<?, ?>> LARGE_JOSHUA_TREE = getter.getOrThrow(RuTreeFeatures.LARGE_JOSHUA_TREE);
        final Holder<ConfiguredFeature<?, ?>> MEDIUM_JOSHUA_TREE = getter.getOrThrow(RuTreeFeatures.MEDIUM_JOSHUA_TREE);
        final Holder<ConfiguredFeature<?, ?>> JOSHUA_TREE_SHRUB = getter.getOrThrow(RuTreeFeatures.JOSHUA_TREE_SHRUB);

        final Holder<ConfiguredFeature<?, ?>> JUNGLE_TREE = getter.getOrThrow(RuTreeFeatures.JUNGLE_TREE);
        final Holder<ConfiguredFeature<?, ?>> BIG_JUNGLE_TREE = getter.getOrThrow(RuTreeFeatures.BIG_JUNGLE_TREE);

        final Holder<ConfiguredFeature<?, ?>> KAPOK_TREE = getter.getOrThrow(RuTreeFeatures.KAPOK_TREE);

        final Holder<ConfiguredFeature<?, ?>> LARCH_TREE = getter.getOrThrow(RuTreeFeatures.LARCH_TREE);
        final Holder<ConfiguredFeature<?, ?>> GOLDEN_LARCH_TREE = getter.getOrThrow(RuTreeFeatures.GOLDEN_LARCH_TREE);

        final Holder<ConfiguredFeature<?, ?>> MAPLE_TREE = getter.getOrThrow(RuTreeFeatures.MAPLE_TREE);
        final Holder<ConfiguredFeature<?, ?>> BIG_MAPLE_TREE = getter.getOrThrow(RuTreeFeatures.BIG_MAPLE_TREE);
        final Holder<ConfiguredFeature<?, ?>> RED_MAPLE_TREE = getter.getOrThrow(RuTreeFeatures.RED_MAPLE_TREE);
        final Holder<ConfiguredFeature<?, ?>> BIG_RED_MAPLE_TREE = getter.getOrThrow(RuTreeFeatures.BIG_RED_MAPLE_TREE);
        final Holder<ConfiguredFeature<?, ?>> ORANGE_MAPLE_TREE = getter.getOrThrow(RuTreeFeatures.ORANGE_MAPLE_TREE);
        final Holder<ConfiguredFeature<?, ?>> BIG_ORANGE_MAPLE_TREE = getter.getOrThrow(RuTreeFeatures.BIG_ORANGE_MAPLE_TREE);

        final Holder<ConfiguredFeature<?, ?>> MAUVE_TREE = getter.getOrThrow(RuTreeFeatures.MAUVE_OAK);
        final Holder<ConfiguredFeature<?, ?>> BIG_MAUVE_TREE = getter.getOrThrow(RuTreeFeatures.BIG_MAUVE_OAK);

        final Holder<ConfiguredFeature<?, ?>> BIG_OAK_TREE = getter.getOrThrow(RuTreeFeatures.BIG_OAK_TREE);
        final Holder<ConfiguredFeature<?, ?>> SMALL_OAK_TREE = getter.getOrThrow(RuTreeFeatures.SMALL_OAK_TREE);
        final Holder<ConfiguredFeature<?, ?>> OAK_TREE_WITH_BRANCH = getter.getOrThrow(RuTreeFeatures.OAK_TREE_WITH_BRANCH);
        final Holder<ConfiguredFeature<?, ?>> OAK_TREE = getter.getOrThrow(RuTreeFeatures.OAK_TREE);
        final Holder<ConfiguredFeature<?, ?>> OAK_TREE_TALL = getter.getOrThrow(RuTreeFeatures.OAK_TREE_TALL);
        final Holder<ConfiguredFeature<?, ?>> OAK_TREE_SHRUB = getter.getOrThrow(RuTreeFeatures.OAK_TREE_SHRUB);
        ...
        final Holder<ConfiguredFeature<?, ?>> PALM_TREE = getter.getOrThrow(RuTreeFeatures.PALM_TREE);
        final Holder<ConfiguredFeature<?, ?>> PALM_TREE_TALL = getter.getOrThrow(RuTreeFeatures.TALL_PALM_TREE);
        final Holder<ConfiguredFeature<?, ?>> PALM_TREE_SHRUB = getter.getOrThrow(RuTreeFeatures.PALM_TREE_SHRUB);

        final Holder<ConfiguredFeature<?, ?>> PINE_TREE = getter.getOrThrow(RuTreeFeatures.PINE_TREE);
        final Holder<ConfiguredFeature<?, ?>> PINE_TREE_TALL = getter.getOrThrow(RuTreeFeatures.PINE_TREE_TALL);
        final Holder<ConfiguredFeature<?, ?>> SCOTTS_PINE_TREE = getter.getOrThrow(RuTreeFeatures.STRIPPED_PINE_TREE);
        final Holder<ConfiguredFeature<?, ?>> SCOTTS_PINE_TREE_TALL = getter.getOrThrow(RuTreeFeatures.STRIPPED_PINE_TREE_TALL);
        final Holder<ConfiguredFeature<?, ?>> SCOTTS_PINE_TREE_MOUNTAIN = getter.getOrThrow(RuTreeFeatures.STRIPPED_PINE_TREE_MOUNTAIN);
        final Holder<ConfiguredFeature<?, ?>> PINE_TREE_SHRUB = getter.getOrThrow(RuTreeFeatures.PINE_TREE_SHRUB);

        final Holder<ConfiguredFeature<?, ?>> LUSH_PINE_TREE = getter.getOrThrow(RuTreeFeatures.LUSH_PINE_TREE);

        final Holder<ConfiguredFeature<?, ?>> ULTRA_REDWOOD_TREE = getter.getOrThrow(RuTreeFeatures.ULTRA_REDWOOD_TREE);
        final Holder<ConfiguredFeature<?, ?>> GIANT_REDWOOD_TREE = getter.getOrThrow(RuTreeFeatures.GIANT_REDWOOD_TREE);
        final Holder<ConfiguredFeature<?, ?>> REDWOOD_TREE = getter.getOrThrow(RuTreeFeatures.REDWOOD_TREE);

        final Holder<ConfiguredFeature<?, ?>> MAGNOLIA_TREE = getter.getOrThrow(RuTreeFeatures.MAGNOLIA_TREE);
        final Holder<ConfiguredFeature<?, ?>> BLUE_MAGNOLIA_TREE = getter.getOrThrow(RuTreeFeatures.BLUE_MAGNOLIA_TREE);
        final Holder<ConfiguredFeature<?, ?>> PINK_MAGNOLIA_TREE = getter.getOrThrow(RuTreeFeatures.PINK_MAGNOLIA_TREE);
        final Holder<ConfiguredFeature<?, ?>> WHITE_MAGNOLIA_TREE = getter.getOrThrow(RuTreeFeatures.WHITE_MAGNOLIA_TREE);
        final Holder<ConfiguredFeature<?, ?>> BIG_MAGNOLIA_TREE = getter.getOrThrow(RuTreeFeatures.BIG_MAGNOLIA_TREE);
        final Holder<ConfiguredFeature<?, ?>> PINK_BIG_MAGNOLIA_TREE = getter.getOrThrow(RuTreeFeatures.BIG_PINK_MAGNOLIA_TREE);
        final Holder<ConfiguredFeature<?, ?>> WHITE_BIG_MAGNOLIA_TREE = getter.getOrThrow(RuTreeFeatures.BIG_WHITE_MAGNOLIA_TREE);

        final Holder<ConfiguredFeature<?, ?>> SAGUARO_CACTUS = getter.getOrThrow(RuTreeFeatures.SAGUARO_CACTUS);

        final Holder<ConfiguredFeature<?, ?>> SPRUCE_TREE_TALL = getter.getOrThrow(RuTreeFeatures.SPRUCE_TREE_TALL);
        final Holder<ConfiguredFeature<?, ?>> SPRUCE_TREE_SHRUB = getter.getOrThrow(RuTreeFeatures.SPRUCE_TREE_SHRUB);

        final Holder<ConfiguredFeature<?, ?>> LARGE_SOCOTRA_TREE = getter.getOrThrow(RuTreeFeatures.LARGE_SOCOTRA_TREE);
        final Holder<ConfiguredFeature<?, ?>> SMALL_SOCOTRA_TREE = getter.getOrThrow(RuTreeFeatures.SMALL_SOCOTRA_TREE);

        final Holder<ConfiguredFeature<?, ?>> ICE_SPIRE = getter.getOrThrow(RuTreeFeatures.ICE_SPIRE);

        final Holder<ConfiguredFeature<?, ?>> SILVER_BIRCH = getter.getOrThrow(RuTreeFeatures.SILVER_BIRCH_TREE);
        final Holder<ConfiguredFeature<?, ?>> SILVER_BIRCH_TALL = getter.getOrThrow(RuTreeFeatures.SILVER_BIRCH_TREE_TALL);

        final Holder<ConfiguredFeature<?, ?>> ENCHANTED_BIRCH = getter.getOrThrow(RuTreeFeatures.ENCHANTED_BIRCH_TREE);
        final Holder<ConfiguredFeature<?, ?>> ENCHANTED_BIRCH_TALL = getter.getOrThrow(RuTreeFeatures.ENCHANTED_BIRCH_TREE_TALL);

        final Holder<ConfiguredFeature<?, ?>> WILLOW_TREE = getter.getOrThrow(RuTreeFeatures.WILLOW_TREE);
        final Holder<ConfiguredFeature<?, ?>> BIG_WILLOW_TREE = getter.getOrThrow(RuTreeFeatures.BIG_WILLOW_TREE);
        final Holder<ConfiguredFeature<?, ?>> WILLOW_TREE_VINES = getter.getOrThrow(RuTreeFeatures.WILLOW_TREE_VINES);
        //--------------------PLACEMENTS--------------------//
        ...
        register(context, RuTreePlacements.TREE_GROUP_OLD_GROWTH_BAYOU, get(getter, RuTreeFeatures.TREE_GROUP_OLD_GROWTH_BAYOU), List.of(CountPlacement.of(4), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(2), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING), BiomeFilter.biome()));
        ...
        register(context, RuTreePlacements.TREE_GROUP_AUTUMNAL_MAPLE_FOREST, get(getter, RuTreeFeatures.TREE_GROUP_AUTUMNAL_MAPLE_FOREST), List.of(
        ...
        register(context, RuTreePlacements.TREE_GROUP_PUMPKIN_FIELDS, get(getter, RuTreeFeatures.TREE_GROUP_PUMPKIN_FIELDS), List.of(
            CountPlacement.of(6),
            InSquarePlacement.spread(),
            SurfaceWaterDepthFilter.forMaxDepth(0),
            PlacementUtils.HEIGHTMAP_OCEAN_FLOOR,
