...
public class RuVegetationFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> PATCH_MEDIUM_GRASS = createKey("patch_medium_grass");
    public static final ResourceKey<ConfiguredFeature<?, ?>> PATCH_WINDSWEPT_GRASS = createKey("patch_windswept_grass");
    public static final ResourceKey<ConfiguredFeature<?, ?>> PATCH_STONE_BUD = createKey("patch_stone_bud");
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> PATCH_MAPLE_LEAF_PILE = createKey("patch_maple_leaf_pile");
    public static final ResourceKey<ConfiguredFeature<?, ?>> PATCH_RED_MAPLE_LEAF_PILE = createKey("patch_red_maple_leaf_pile");
    public static final ResourceKey<ConfiguredFeature<?, ?>> PATCH_ORANGE_MAPLE_LEAF_PILE = createKey("patch_orange_maple_leaf_pile");
    public static final ResourceKey<ConfiguredFeature<?, ?>> PATCH_SILVER_BIRCH_LEAF_PILE = createKey("patch_silver_birch_leaf_pile");
    public static final ResourceKey<ConfiguredFeature<?, ?>> PATCH_ENCHANTED_BIRCH_LEAF_PILE = createKey("patch_enchanted_birch_leaf_pile");
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        //SHRUBS
        register(context, ASHEN_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.ASHEN_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, ACACIA_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.ACACIA_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, BAOBAB_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.BAOBAB_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, BIRCH_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.BIRCH_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, BLACKWOOD_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.BLACKWOOD_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, CHERRY_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.CHERRY_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, MAGNOLIA_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.MAGNOLIA_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, PINK_MAGNOLIA_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.PINK_MAGNOLIA_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, WHITE_MAGNOLIA_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.WHITE_MAGNOLIA_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, CYPRESS_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.CYPRESS_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, DARK_OAK_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.DARK_OAK_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, DEAD_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.DEAD_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, DEAD_PINE_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.DEAD_PINE_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, EUCALYPTUS_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.EUCALYPTUS_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, FLOWERING_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.FLOWERING_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, JOSHUA_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.JOSHUA_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, JUNGLE_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.JUNGLE_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, LARCH_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.LARCH_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, GOLDEN_LARCH_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.GOLDEN_LARCH_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, MANGROVE_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.MANGROVE_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, MAPLE_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.MAPLE_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, RED_MAPLE_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.RED_MAPLE_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, ORANGE_MAPLE_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.ORANGE_MAPLE_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, MAUVE_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.MAUVE_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, OAK_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.OAK_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, PALM_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.PALM_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, PINE_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.PINE_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, REDWOOD_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.REDWOOD_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, SILVER_BIRCH_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.SILVER_BIRCH_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, SOCOTRA_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.SOCOTRA_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, SPRUCE_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.SPRUCE_NATURAL_SET.getShrub().defaultBlockState())));
        register(context, WILLOW_SHRUB, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(BlockStateProvider.simple(RuBlocks.WILLOW_NATURAL_SET.getShrub().defaultBlockState())));
        //mixes
        register(context, BAOBAB_ACACIA_SHRUB_MIX, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.BAOBAB_NATURAL_SET.getShrub().defaultBlockState(), 2).add(RuBlocks.ACACIA_NATURAL_SET.getShrub().defaultBlockState(), 1))));
        ...
        register(context, BIRCH_SHRUB_MIX, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.SILVER_BIRCH_NATURAL_SET.getShrub().defaultBlockState(), 3).add(RuBlocks.BIRCH_NATURAL_SET.getShrub().defaultBlockState(), 1))));
        register(context, BLACKWOOD_DARK_OAK_SHRUB_MIX, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.BLACKWOOD_NATURAL_SET.getShrub().defaultBlockState(), 3).add(RuBlocks.DARK_OAK_NATURAL_SET.getShrub().defaultBlockState(), 1))));
        ...
        register(context, DEAD_SHRUB_MIX, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.DEAD_NATURAL_SET.getShrub().defaultBlockState(), 2).add(RuBlocks.DEAD_PINE_NATURAL_SET.getShrub().defaultBlockState(), 1))));
        register(context, LARCH_SHRUB_MIX, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.LARCH_NATURAL_SET.getShrub().defaultBlockState(), 3).add(RuBlocks.GOLDEN_LARCH_NATURAL_SET.getShrub().defaultBlockState(), 1))));
        register(context, GOLDEN_LARCH_SHRUB_MIX, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.LARCH_NATURAL_SET.getShrub().defaultBlockState(), 1).add(RuBlocks.GOLDEN_LARCH_NATURAL_SET.getShrub().defaultBlockState(), 3))));
        register(context, MAPLE_SHRUB_MIX, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.MAPLE_NATURAL_SET.getShrub().defaultBlockState(), 4).add(RuBlocks.RED_MAPLE_NATURAL_SET.getShrub().defaultBlockState(), 1))));
        register(context, MAUVE_ENCHANTED_SHRUB_MIX, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.MAUVE_NATURAL_SET.getShrub().defaultBlockState(), 3).add(RuBlocks.ENCHANTED_BIRCH_NATURAL_SET.getShrub().defaultBlockState(), 1))));
        register(context, PINE_SPRUCE_SHRUB_MIX, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.PINE_NATURAL_SET.getShrub().defaultBlockState(), 1).add(RuBlocks.SPRUCE_NATURAL_SET.getShrub().defaultBlockState(), 1))));
        register(context, PINE_DEAD_SHRUB_MIX, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.PINE_NATURAL_SET.getShrub().defaultBlockState(), 2).add(RuBlocks.DEAD_PINE_NATURAL_SET.getShrub().defaultBlockState(), 1))));
        register(context, PALM_JUNGLE_SHRUB_MIX, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.PALM_NATURAL_SET.getShrub().defaultBlockState(), 5).add(RuBlocks.JUNGLE_NATURAL_SET.getShrub().defaultBlockState(), 1))));
        register(context, WILLOW_CYPRESS_SHRUB_MIX, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.WILLOW_NATURAL_SET.getShrub().defaultBlockState(), 2).add(RuBlocks.CYPRESS_NATURAL_SET.getShrub().defaultBlockState(), 1))));
        register(context, WILLOW_MAGNOLIA_SHRUB_MIX, FeatureRegistry.SHRUB.get(), new ShrubConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(RuBlocks.WILLOW_NATURAL_SET.getShrub().defaultBlockState(), 2).add(RuBlocks.BLUE_MAGNOLIA_NATURAL_SET.getShrub().defaultBlockState(), 1))));
